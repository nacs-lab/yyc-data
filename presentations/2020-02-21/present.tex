  ...
  \begin{center}
    \begin{tikzpicture}
      \visible<-8>{
        ...
        \node[left,purple!80!black] at (-3.6, 3.75) {$\Delta$};
      ...
      \begin{scope}[shift={(0, 1.2)}]
        \visible<2-6>{
          \node[right,align=left] at (1, 1) {
            $\gamma_{scatter}=\dfrac{{\color{blue!80!black} \Gamma_e}\ {\color{green!80!black} \Omega}^2}{2\ {\color{purple!80!black} \Delta}^2}$};
        }
        \visible<7->{
          \node[right,align=left] at (1, 1) {
            $\gamma_{scatter}=\dfrac{{\color{blue!80!black} \Gamma_e}\ {\color{green!80!black} \Omega}^2}{2\ {\color{purple!80!black} \Delta}^2}{\color{red}\times 10 \sim 100}$};
        }
        \visible<3->{
        ...
        \visible<6->{
          \draw[->, line width=1,purple!80!black] (3.14, 0.5) -- (2.9, -0.2) node[below] {\footnotesize Detuning};
        }
        \visible<8->{
