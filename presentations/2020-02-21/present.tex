      ...
      \begin{scope}[shift={(0, 1.2)}]
        \visible<2-6>{
          \node[right,align=left] at (1, 1) {
            $\gamma_{scatter}=\dfrac{{\color{blue!80!black} \Gamma_e}\ {\color{green!80!black} \Omega}^2}{2\ {\color{purple} \Delta}^2}$};
        }
        \visible<7->{
          \node[right,align=left] at (1, 1) {
            $\gamma_{scatter}=\dfrac{{\color{blue!80!black} \Gamma_e}\ {\color{green!80!black} \Omega}^2}{2\ {\color{purple} \Delta}^2}{\color{red}\times 10 \sim 100}$};
        }
        \visible<3->{
