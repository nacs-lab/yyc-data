      ...
      \visible<4->{
        ...
        \visible<5>{
          \begin{scope}[shift={(4, -8.5)}]
            ...
            \draw (1.0269 + 1, 2.5) -- (8, 2.5);
            \draw (1.0793 + 1, -0.4631 + 2.5) -- (4.5 + 1, -0.4631 + 2.5);
            \node[left,rotate=90] at (1.55 + 1, -0.46 + 2.5) {$\cdots$};

            \draw[line width=1.1,cyan!85!blue]
            plot[samples=200,domain=1:7,variable=\x]
            ({\x + 1}, {6.8*\x^(-3.4)-6.5*\x^(-1.7) + 2.5});
            \node[cyan!85!blue] at (4.5, 1.0) {$a^3\Sigma^+$};

            \draw[line width=1.1,red]
            plot[samples=200,domain=1:8,variable=\x] ({\x}, {9.2*\x^(-2.5)-9.0*\x^(-1.3) + 7.5});
            \node[above right,red] at (1.3, 7.2) {$c^3\Sigma^+$};

            \mytweezer.drawNaAtom(7.3, 2.6, 0.12)
            \mytweezer.drawCsAtom(7.8, 2.6, 0.10)

            \mytweezer.drawNaAtom(4.83, 2.15, 0.12)
            \mytweezer.drawCsAtom(5, 2.15, 0.10)

            \draw[black!40,dashed,line width=1] (1, 5) -- (8, 5);

            \draw[->,green!80!black,line width=0.8] (7.55, 2.7) -- (6.25, 5);
            \draw[->,green!80!black,line width=0.8] (6.2, 5) -- (4.915, 2.25);
          \end{scope}
        }
      }
    \end{tikzpicture}
