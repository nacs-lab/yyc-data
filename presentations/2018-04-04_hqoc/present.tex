      ...
      \visible<4->{
        ...
        \visible<5>{
          \begin{scope}[shift={(4, -8.5)}]
            ...
            \node[left,rotate=90,cyan!85!blue] at (1.55 + 0.25, -0.46 + 2.5) {$\cdots$};
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \visible<2->{
        ...
        \draw[dotted,opacity=0.5,line width=1] (3.72, -0.9) -- (6.45, -2.5);
        \draw[dotted,opacity=0.5,line width=1] (3.58, -0.9) -- (1.81, -2.5);
        \node at (4, -4) {\includegraphics[width=5cm]{eit.png}};
        \node[below] at (4, -5.7) {\small Two photon detuning (MHz)};
      }
      \begin{scope}[shift={(-4, -7)},scale=0.65]
        \draw[->,line width=1.2] (0, 0) -- (0, 8);
        \node[above,rotate=90] at (0, 4) {Energy};
        \draw[->,line width=1.2] (0, 0) -- (8, 0);
        \node[below] at (4, -0.5) {Internuclear distance};
        ...
        \draw[snakearrow,red!50!blue,line width=0.8] (6.8, 2.7) -- (4.5 - 0.75, -0.85 + 7.5);
        \only<2->{
