...
% Our measurement is done on single Na and Cs atoms.
  ...
  \begin{center}
    \begin{columns}
      ...
      \begin{center}
        ...
        \vspace{0.5cm}
        \visible<5->{\includegraphics[width=5cm]{na2cs3.pdf}}
      \end{center}
    \end{columns}
  \end{center}
\end{frame}
...
\begin{frame}[t]{Feshbach resonance}
  \only<1>{
    \begin{center}
