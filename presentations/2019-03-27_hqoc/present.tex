...
\author[Yichao Yu]{Yichao Yu\\
  ...
  {\footnotesize Jessie Zhang, Eliot Fenton, Yen-Wei Lin}}
% Add 1.5
  ...
  \begin{center}
    \begin{columns}
      ...
      \begin{center}
        \begin{tikzpicture}
          \visible<1>{
            \node at (0, 1) {\includegraphics[width=6.3cm]{shift_raman_1.pdf}};
          }
          \visible<2-4>{
            \node at (0, 1) {\includegraphics[width=6.3cm]{shift_raman.pdf}};
          }
          \visible<5>{
            \node at (0, 0) {\includegraphics[width=6.3cm]{shift_theory.pdf}};
          }
          \visible<6>{
            \node at (0, 0) {\includegraphics[width=6.3cm]{shift_theory42_32.pdf}};
          }
          \visible<7>{
            \node at (0, 0) {\includegraphics[width=6.3cm]{shift_theory32_31.pdf}};
          }
        \end{tikzpicture}
      \end{center}
      \column{5.5cm}
      \begin{center}
        \begin{tikzpicture}
          \visible<2-5>{\node at (0, 2) {\includegraphics[width=5cm]{na2cs4_0.pdf}};}
          \visible<6->{\node at (0, 2) {\includegraphics[width=5cm]{na2cs4.pdf}};}
          \visible<7->{\node at (0, -2) {\includegraphics[width=5cm]{na2cs3.pdf}};}
        \end{tikzpicture}
      \end{center}
    \end{columns}
  \end{center}
