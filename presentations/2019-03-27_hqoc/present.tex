...
\begin{frame}{Interaction shift}
  \begin{center}
    \begin{columns}
      \column{6cm}
      \begin{center}
        \includegraphics[width=5cm]{shift_raman.pdf}\\
        \includegraphics[width=5cm]{shift_theory.pdf}
      \end{center}
      \column{6cm}
      \begin{center}
        \includegraphics[width=5cm]{na2cs4.pdf}\\
        \includegraphics[width=5cm]{na2cs3.pdf}
      \end{center}
    \end{columns}
  \end{center}
\end{frame}
...
\begin{frame}{Feshbach resonance}
  \begin{center}
    \includegraphics[width=11cm]{fb.pdf}
  \end{center}
\end{frame}

\begin{frame}{Next step}
  \begin{center}
    Take advantage of the large scattering length to enhance molecule formation.
    \vspace{0.5cm}
    \visible<2->{
