...
% so I'll start with why we are using .....
...
% On the other hand, there's basically one probably with atoms
% * Too simple
% The tricks that you can play with them is limited.
...
% Want to get to here.
% No matter which state, the energy difference is huge and the wavefunction is dissimilar.
