...
\begin{frame}{Applications}
  \begin{block}{\only<1>{Simulation of many-body system\sfcite{Yan2013}}
    ...
    \begin{center}
      \begin{tikzpicture}
        \visible<1>{
          \path (2.5, 0) node {\includegraphics[width=4cm]{many-body-oscillation.png}};
          \path (-3.5, 0) node {\includegraphics[width=7cm]{many-body-coupling.jpg}};
        }
        \visible<2>{
          \path (-1, 0) node {\includegraphics[width=7.5cm]{compute-geometry.png}};
        }
      \end{tikzpicture}
    \end{center}
  \end{block}
...
\begin{frame}{Atom loading and cooling}
  \begin{columns}
    ...
    \begin{center}
      \begin{tikzpicture}
        \visible<1>{
          \path (0, 0) node {\includegraphics[width=6cm]{cs-histogram.png}};
        }
        \visible<2>{
          \path (0, 0) node {\includegraphics[width=6cm]{cs-raman-combined.pdf}};
        }
      \end{tikzpicture}
    \end{center}
  \end{columns}
