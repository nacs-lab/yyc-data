  ...
  \begin{block}{\only<1>{\hyperlink{backup-many-body-echo}{Simulation of many-body system}\sfcite{Yan2013}}
    ...
    \begin{center}
      \begin{tikzpicture}
        ...
        \visible<2>{
          \path (-1, 0) node {\hyperlink{backup-exchange-term}{\includegraphics[width=7.5cm]{imgs/compute-geometry.png}}};
        }
      \end{tikzpicture}
    \end{center}
  \end{block}
...
% * Cooling
% * Merging
% * Make molecule [TODO: backup slides]
...
\begin{frame}{\hyperlink{making-molecule-rsc}{Raman sideband cooling}}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \draw[line width=1]
      plot[domain={-2.5}:{2.5},variable=\x] ({\x}, {(\x)^2});
    \end{tikzpicture}
  \end{center}
\end{frame}
% Na cooling challenges
% * High initial temperature
% * High Lamb-Dicke parameter (Raman and OP) TODO: define
% * Large light shift
    ...
    \begin{tikzpicture}
      ...
      \begin{scope}[transform canvas={shift={(\trapcenterx, \trapcentery)}}]
        ...
        \visible<2,4->{
          ...
          (-1.57, -0.25+1.57*0.28) arc (-90:40:0.15 and 0.25);
        }
        \visible<3->{
        ...
        \begin{scope}[transform canvas={cm={1,-0.28,0,1,(0, 0)}}]
          ...
          \fill[blue!50!black,opacity=0.1] (-1.9, 1.65) -- (1.8, 1.65)
          -- (1.8, -1.6) -- (-1.9, -1.6) -- cycle;
          \draw[blue!50!black, densely dotted,line width=0.6] (-1.9, 1.65) -- (1.8, 1.65)
          -- (1.8, -1.6) -- (-1.9, -1.6) -- cycle;
          \visible<2,4->{
            \arrowthreeD{red}{(0, -0.2)}{180}{0.3}{1};
            \arrowthreeD{orange}{(-0.2, 0)}{90}{0.3}{1.3};
        ...
        \visible<2,4->{
          ...
          (-1.57, -0.25+1.57*0.28) arc (-90:-200:0.15 and 0.25);
        }
      ...
      \node[text width=6cm,above right,align=center] at (4.1, -3.2) {
        \begin{itemize}
        \item<4-> High initial temperature ($70\mu K$)
        \item<5-> High Lamb Dicke parameter
        \item<8-> Large light shift
        \item<9-> Trap anharmonicity
        \item<10-> Off resonance scattering from Raman beams\\
...
\begin{frame}{\hyperlink{making-molecule-merge-trap}{Merge trap}}
