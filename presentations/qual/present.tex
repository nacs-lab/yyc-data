...
\begin{frame}{}
  \begin{center}
    \begin{tikzpicture}
      ...
      \visible<5-8>{
        \fill[white, opacity=0.97] (-2.22, 5.2) rectangle (9.9, -2.7);
      }
      \visible<5>{
      ...
      \visible<8>{
        ...
        \node[below left] at (9.9, 5.5) {\hyperlink{backup-diff-adiabatic}{\includegraphics[width=6cm]{../../experiments/adiabatic_lowering/imgs/AC_old-pulsed_pdf.png}}};
      }
