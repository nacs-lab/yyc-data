...
\begin{tikzpicture}[scale=0.9]
  ...
  \begin{scope}
    \clip (4.6, -2.1) rectangle (17.8, 2.0);
    %% Pulse mark
    \foreach \i in {0,...,7} {
    ...
    \foreach \i in {0,...,3} {
      \path (5.6*\i + 0.8, -0.15) node[below,blue,align=center] {\textbf{$m$-th}\\\textbf{order}};
      \path (5.6*\i + 3.6, -0.15) node[below,blue,align=center] {\textbf{$(\!m-1\!)$-th}\\\textbf{order}};
    }
    ...
    \foreach \i in {0,...,7} {
      ...
      (2.8*\i+1.58, -2) rectangle (2.8*\i+1.91, -1);
      \filldraw[fill=orange!30,draw=orange,line width=1.2]
      (2.8*\i+2.48, -2) rectangle (2.8*\i+2.81, -1);
    }
    \draw[line width=2,orange] (0,-2) -- (22.4,-2);
  \end{scope}

  \fill[white,path fading=fade img right] (16.8, -2.2) rectangle (17.81, 1.6);
  \fill[white,path fading=fade img right] (16.8, -2.2) rectangle (17.81, 1.6);
  \fill[white,path fading=fade img right] (16.8, -2.2) rectangle (17.81, 1.6);

  \fill[white,path fading=fade img left] (5.6, -2.2) rectangle (4.59, 1.6);
  \fill[white,path fading=fade img left] (5.6, -2.2) rectangle (4.59, 1.6);
  \fill[white,path fading=fade img left] (5.6, -2.2) rectangle (4.59, 1.6);

  % \path (5.0, 2.3) node[left,purple,align=center] {\textbf{Tweezer}};
  \node[above,align=center] at (5.7, 1.7) {\large \textbf{Raman}};
  \node[below,orange,align=center] at (5.7, -2.4)
  {\large \textbf{Optical}\\\large \textbf{pumping}};
  \draw[line width=2,orange,->,>=stealth] (5.6,-2) -- (17.8,-2) node[right, below] {\scalebox{2}{$t$}};
