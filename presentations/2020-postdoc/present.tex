...
\begin{frame}[t]{Experiment overview}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=0.7]
      ...
      \visible<4>{
        \node[above,align=center] at (7.5, -3.5)
        {\usebeamerfont{frametitle}\usebeamercolor[fg]{frametitle}{\large Interaction}\\
          \includegraphics[width=5.1cm]{na2cs4}};
        \node[below,align=center] at (7.5, -3.5)
        {\usebeamerfont{frametitle}\usebeamercolor[fg]{frametitle}{\large Molecule formation}\\
          \includegraphics[width=5.1cm]{../../experiments/nacs_202007/imgs/fit_20200703_201618_raman15_3322_2_postdoc_t.pdf}};
      }
    \end{tikzpicture}
    \vspace{-2cm}
  \end{center}
...
% our tweezer and imaging beam paths, as well as many others around.
...
% If we drive the transition on the sideband, we can either add, or remove motional energy
% from the atoms. In additional to being a tool to cool the atoms, since there are
% fewer states for decreasing the energy than to increase the energy, this is also
% a tool to measure the temperature of the atoms. As the temperature of the atoms
% get lower, the cooling sideband will be more and more surpressed and
...
% similar to what we have on average, the atom might end up in a wide varity of states,
    ...
    \begin{tikzpicture}
      ...
      \visible<10->{
        \node[below,text width=5.5cm,align=center] at (6.6, 0.5) {
          ...
          Use higher order sidebands.
        };
      }
      \visible<13-> {
        \node[red] at (6.6, -2) {3D ground state: $93.5(7)\%$};
      }
      \visible<7>{
      ...
      \visible<12->{
        \node[below,align=center] at (0.5, 4.5) {
...
\begin{frame}{Interaction shift}
  ...
  \begin{tikzpicture}
    ...
    \visible<11->{
      \node at (1.3, -2) {\includegraphics[width=5cm]{../../experiments/nacs_201904/imgs/data_20190521_lifetime_cmp_lin.pdf}};
    }
  \end{tikzpicture}
\end{frame}
\fi
    ...
    \begin{tikzpicture}
      ...
      \visible<5-> {
        \node[below, text width=5.5cm, align=center] at (-3, 3.4)
        {
          ...
          \item<6-> Improving signal
          \item<9-> Single molecule spin state
          \item<9-> $>50\%$ of molecule in motional ground state.
          \end{itemize}
        };
      }
      \visible<5-6> {
...
\begin{frame}{Na Raman sideband cooling sequence}
  \begin{center}
    \includegraphics[width=11cm]{sequence}
  \end{center}
\end{frame}
