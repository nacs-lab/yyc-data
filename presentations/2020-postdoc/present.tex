    ...
    \begin{tikzpicture}[scale=0.7]
      ...
      \visible<2>{
        ...
        \only<2>{
          ...
          {Cs: 96\% ground state\footnote{PRX 9, 021039}\\
            Na: 94\% ground state\footnote{PRA 97, 063423}};
        }
      }
      \visible<3>{
        \node[above,align=center] at (7, 0)
...
\begin{frame}{Interaction shift}
  ...
  \begin{tikzpicture}
    ...
    % Data 1
    \visible<3>{\node at (3.2, 0) {\includegraphics[width=5cm]{na2cs4_0s.pdf}};}
    ...
    \visible<11->{
      \draw[->, line width=1, color=red!50!black] (0.8, 1.45) -- (-0.8, 0.5)
  ...
  \begin{center}
    ...
    \begin{tikzpicture}
      ...
      \visible<5-> {
        ...
        {
          \begin{itemize}
          \item Transferred \alt<-7>{$50\%$}{$63\%$} of ground state atom to molecule.
          \item<6-> Single molecule spin state
          \item<6-> $>50\%$ of molecule in motional ground state.
          \item<7-> Improving signal
          \end{itemize}
        };
      }
      \visible<5-7> {
...
\begin{frame}[t]{Conclusion and outlook}
  ...
  \begin{columns}
    ...
    \item<2-> Working towards fully controlled, strongly interacting tweezer array
    \item<3-> Improve molecule lifetime and signal contrast
    \item<4-> Feshbach molecule\\
