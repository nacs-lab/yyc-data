...
\begin{frame}{Interaction shift}
  ...
  \begin{tikzpicture}
    ...
    \visible<11->{
      \draw[->,>=stealth,line width=1,color=red!50!black] (0.8, 1.45) -- (-0.8, 0.5)
  ...
  \begin{center}
    ...
    \begin{tikzpicture}
      ...
      \visible<6-> {
        ...
        {
          \begin{itemize}
          \item Transferred \alt<-8>{$50\%$}{$63\%$} of ground state atom to molecule.
...
\begin{frame}[t]{Conclusion and outlook}
  ...
  \begin{columns}
    \column{6.25cm}
    \begin{itemize}
    \item New system for quantum computing and quantum simulation
      using ultracold molecules in tweezers
