...
% Mention other experiments, ion, ground state cooling.
% CaF array picture
% Na + Cs single atom picture

%% Forming molecules vs cooling molecules
% * Achieve quantum control
% * Coherent formation

% * Start with a general procedure of our experiment

% Lab picture
% RSC (Na + Cs)

% big picture at the end (next step transfer)
