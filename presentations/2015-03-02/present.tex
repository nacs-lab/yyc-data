  ...
  \begin{columns}
    ...
    \only<3-11>{
      \begin{block}{}
        ...
        \item<4-> Light
          \begin{itemize}
          \item<5-> Power: \visible<6->{
              Alignment and scattering measurement \checkmark}
          \item<7-> Frequency: \visible<8->{Beat note \checkmark}
          \end{itemize}
        \item<9-> State
          \begin{itemize}
          \item<10-> Dark state pumping \checkmark
          \item<11-> Cycling transition detuning \checkmark
          \end{itemize}
        \end{itemize}
      \end{block}
    }
