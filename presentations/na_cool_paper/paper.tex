...
\end{figure}
\begin{figure*}
  \includegraphics[height=4cm]{imgs/spectrum_r.pdf}
  \includegraphics[height=4cm]{imgs/rabi_flop_r3_0.png}
  \includegraphics[height=4cm]{imgs/rabi_flop_r3_p1.png}
  \caption{(A) (B) \label{f-radial}}
\end{figure*}
\begin{figure*}
  \includegraphics[height=4cm]{imgs/spectrum_a1.pdf}
  \includegraphics[height=4cm]{imgs/rabi_flop_a1_0.png}
  \includegraphics[height=4cm]{imgs/rabi_flop_a1_p1.png}
