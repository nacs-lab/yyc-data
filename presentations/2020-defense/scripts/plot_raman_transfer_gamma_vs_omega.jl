...
figure()
ax = gca()
errorbar(Ω_mol_0, Γ_mol_0, xerr=unc_Ω_mol_0, yerr=unc_Γ_mol_0, fmt="C0o-", label="0 filter")
errorbar(Ω_mol_1, Γ_mol_1, xerr=unc_Ω_mol_1, yerr=unc_Γ_mol_1, fmt="C1o-", label="1 filter")
...
xlabel("\$\\Omega_{\\mathrm{R}}~(\\mathrm{2\\pi\\cdot kHz})\$")
ylabel("\$\\Gamma_{\\mathrm{m}}~(\\mathrm{2\\pi\\cdot kHz})\$")
