...
% Uncomment this to disable all slides except ones that are enabled with \slideOn
    ...
    \begin{tikzpicture}
      ...
      \visible<4->{
        \node[below,align=center,text width=5cm] at (6, 2.2) {
          ...
          \item<5-> Rich internal structure
          \item<6-> Long coherence time
...
\begin{frame}[t]{Experiment overview}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=0.7]
      ...
      \visible<3>{
        \draw[red,dashed,line width=0.5] (-1.5, -7.2) rectangle (0.5, -2.9);
        \node[above,align=center] at (7, 0)
        ...
        \draw[dotted,line width=2,black!30,opacity=10] (0.5, -2.9) -- (4.5, -0.5);
        \draw[dotted,line width=2,black!30,opacity=10] (0.5, -7.2) -- (4.5, -9.3);
      }
      \visible<4>{
        ...
        \node[align=center] at (10, 0.2) {\usebeamercolor[fg]{frametitle}{Molecule Creation}\\
        ...
        {\includegraphics[width=3cm]{figures/overview_science_cover}\\
...
\begin{frame}{Interaction shift}
  ...
  \begin{tikzpicture}
    ...
    \visible<6-7>{
      \draw[line width=1] plot[domain={-1:1},smooth,variable=\x]
      ({\x * 0.8 - 4.5}, {(\x)^2 * 1.5 + 0.5});
      \mytweezer.drawNaAtom(-4.45, 0.9, 0.16)
      \draw[->,atomorange,line width=0.8] (-4.8, 1.1) -- (-4.2, 1.1);
      \node[atomorange] at (-3.9, 0.5) {\small Na};

      \draw[line width=1] (-4.5 - 0.3, 0) -- (-4.5 + 0.3, 0);
      \draw[line width=1] (-4.5, 0 - 0.3) -- (-4.5, 0 + 0.3);

      \draw[line width=1] plot[domain={-1:1},smooth,variable=\x]
      ({\x * 0.8 - 4.5}, {(\x)^2 * 1.5 - 2});
      \mytweezer.drawCsAtom(-4.55, -1.7, 0.12)
      \draw[->,blue,line width=0.8] (-4.2, -1.5) -- (-4.8, -1.5);
      \node[blue] at (-3.9, -2) {\small Cs};

      \draw[->,line width=1.5] (-3.5, 0) -- (-1.5, 0);

      \draw[line width=1] plot[domain={-1:1},smooth,variable=\x]
      ({\x * 0.8 - 0.5}, {(\x)^2 * 1.5 + 0.5});
      \mytweezer.drawNaAtom(-0.35, 0.9, 0.16)
      \mytweezer.drawCsAtom(-0.65, 0.9, 0.12)
      \draw[->,atomorange,line width=0.8] (-0.6, 1.15) -- (-0.1, 1.15);
      \draw[->,blue,line width=0.8] (-0.9, 1.25) -- (-0.4, 1.25);
      \node[align=left,
      execute at begin node=\setlength{\baselineskip}{9pt}]
      at (-1.4, 0.7) {\small Center\\\small of mass};

      \draw[line width=1] (-0.5 - 0.3, 0) -- (-0.5 + 0.3, 0);
      \draw[line width=1] (-0.5, 0 - 0.3) -- (-0.5, 0 + 0.3);

      \draw[line width=1] plot[domain={-1:1},smooth,variable=\x]
      ({\x * 0.8 - 0.5}, {(\x)^2 * 1.5 - 2});
      \mytweezer.drawNaAtom(-0.3, -1.5, 0.16)
      \mytweezer.drawCsAtom(-0.75, -1.5, 0.12)
      \draw[->,atomorange,line width=0.8] (-0.50, -1.3) -- (-0.03, -1.3);
      \draw[->,blue,line width=0.8] (-0.58, -1.3) -- (-0.95, -1.3);
      \node[below] at (-0.5, -2) {\small Relative};
    }
    \visible<7->{
...
\begin{frame}
  \begin{center}
    \begin{tikzpicture}
      ...
      %% Former member
      \node[below,align=center, execute at begin node=\setlength{\baselineskip}{7.5pt}]
      at (-3.5, -6.6) {\includegraphics[height=1.5cm]{figures/acknowledgement_lee}\\
        \scriptsize Lee Liu\\\tiny Postdoc @JILA};
      \node[below,align=center, execute at begin node=\setlength{\baselineskip}{7.5pt}]
      at (-2.05, -6.6) {\includegraphics[height=1.5cm]{figures/acknowledgement_nick}\\
        \scriptsize Nick Hutzler\\\tiny AP @Caltech};
      \node[below,align=center, execute at begin node=\setlength{\baselineskip}{7.5pt}]
      at (-0.4, -6.6) {\includegraphics[height=1.5cm]{figures/acknowledgement_jon}\\
        \scriptsize Jonathan Hood\\\tiny AP @Purdue};
      \node[below,align=center, execute at begin node=\setlength{\baselineskip}{7.5pt}]
      at (1.0, -6.6) {\includegraphics[height=1.5cm]{figures/acknowledgement_eliot}\\
        \scriptsize Eliot\\\scriptsize Fenton};
      \node[below,align=center, execute at begin node=\setlength{\baselineskip}{7.5pt}]
      at (2.5, -6.6) {\includegraphics[height=1.5cm]{figures/acknowledgement_yenwei}\\
        \scriptsize Yen-Wei Lin\\\tiny Intelon Optics};
      \node[below,align=center, execute at begin node=\setlength{\baselineskip}{7.5pt}]
      at (4.0, -6.6) {\includegraphics[height=1.5cm]{figures/acknowledgement_yu}\\
        \scriptsize Yu Liu\\\tiny Postdoc @NIST};
      \node[below,align=center, execute at begin node=\setlength{\baselineskip}{7.5pt}]
      at (5.5, -6.6) {\includegraphics[height=1.5cm]{figures/acknowledgement_andrei}\\
        \scriptsize Andrei\\\scriptsize  Gheorghe};
      \node[below,align=center, execute at begin node=\setlength{\baselineskip}{7.5pt}]
      at (6.9, -6.6) {\includegraphics[height=1.5cm]{figures/acknowledgement_david}\\
