...
% creating single NaCs molecules in optical tweezers from atoms.
{
  \usebackgroundtemplate{
    \makebox[\paperwidth][c]{\centering\includegraphics[width=\paperwidth]{figures/front_bg.png}}
  }
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \node[below, align=center] (CaFnode) at (-3, 3.5) {
        \includegraphics[width=6cm]{figures/CaF_tweezer.png}\\
        \vspace{0.5cm}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=0.7]
      ...
      \visible<1>{
        ...
        {\includegraphics[width=5cm]{figures/single_viridis.png}};
      ...
      \visible<2>{
        ...
        \node[below] at (6.5, -1)
        {\includegraphics[width=6cm]{figures/spectrum_nolabel_az.pdf}};
        \only<2>{
      ...
      \visible<4>{
        \node[align=center] at (8, -3.5) {\includegraphics[width=4cm]{figures/science_cover}\\
...
\begin{frame}{}
  \begin{center}
    \begin{tikzpicture}
      \visible<1>{
        \node at (-3, 0) {\includegraphics[width=9cm]{figures/chamber}};
      }
      \visible<2-3>{
        \node at (-3, 0) {\includegraphics[width=9cm]{figures/chamber_center}};
      }
      \visible<4>{
        \node at (-3, 3.5) {\usebeamercolor[fg]{frametitle}{\textbf{MOT beam path}}};
        \node at (-3, 0) {\includegraphics[width=9cm]{figures/chamber_mot}};
      }
      \visible<5>{
        \node at (-3, 3.5) {\usebeamercolor[fg]{frametitle}{\textbf{Tweezer beam path}}};
        \node at (-3, 0) {\includegraphics[width=9cm]{figures/chamber_tweezer}};
      }
      \visible<3> {
        ...
        \node at (2, 0) {\includegraphics[width=5cm]{figures/na_mot}};
...
\begin{frame}{Raman sideband cooling}
  \todo{
    Expand on RSC
    Draw trajectory of atom (using dimming arrow to show the previous step)
  }
  \vspace{-0.5cm}
  \begin{center}
    \begin{tikzpicture}
      ...
      \visible<7>{
        \node[below] at (0.5, 4.5) {\includegraphics[width=5.4cm]{figures/op_branching_1.pdf}};
      }
      \visible<8-12>{
        \node[below] at (0.5, 4.5) {\includegraphics[width=5.4cm]{figures/op_branching.pdf}};
      }
      \visible<13->{
        \node[below] at (0.5, 3.7) {\includegraphics[width=6.5cm]{figures/sequence}};
      }
      \visible<9-11>{
        \node[below] at (0.5, 0.5) {\includegraphics[width=5.4cm]{figures/raman_rabi_1.pdf}};
      }
      \visible<10-11>{
        \node[below] at (0.5, 0.5) {\includegraphics[width=5.4cm]{figures/raman_rabi_1.pdf}};
      ...
      \visible<12-13>{
        \node[below] at (0.5, 0.5) {\includegraphics[width=5.4cm]{figures/raman_rabi_all.pdf}};
      }
      \visible<14->{
        \node[below,align=center] at (0.5, 0.5) {
          Axial sideband spectrum\\
         \includegraphics[width=5.4cm]{figures/spectrum_az}
        };
      }
    \end{tikzpicture}
  \end{center}
...
\begin{frame}{Interaction shift}
  ...
  \begin{tikzpicture}
    ...
    % Raman sequence
    \visible<1>{
      \node at (-2.8, 0.7) {\includegraphics[width=6cm]{figures/shift_raman_1.pdf}};
    }
    \visible<2-4>{
      \node at (-2.8, 0.7) {\includegraphics[width=6cm]{figures/shift_raman.pdf}};
    }
    % Data 1
    \visible<3->{
    ...
    \visible<3>{\node at (3.2, -0.4) {\includegraphics[width=5cm]{figures/na2cs4_0s.pdf}};}
    \visible<4-7>{\node at (3.2, -0.4) {\includegraphics[width=5cm]{figures/na2cs4_0.pdf}};}
    \visible<8>{\node at (3.2, -0.4) {\includegraphics[width=5cm]{figures/na2cs4.pdf}};}
    \visible<9->{\node at (3.2, -0.4) {\includegraphics[width=5cm]{figures/na2cs3.pdf}};}
    ...
    \visible<7>{
      \node at (-2.6, 0.5) {\includegraphics[width=6cm]{figures/shift_theory.pdf}};
    }
    \visible<8>{
      \node at (-2.6, 0.5) {\includegraphics[width=6cm]{figures/shift_theory42_32.pdf}};
    }
    \visible<9->{
      \node at (-2.6, 0.5) {\includegraphics[width=6cm]{figures/shift_theory32_31.pdf}};
    }
    \visible<10->{
    ...
    \visible<11->{
      ...
      \node[below] at (-3, 0) {\includegraphics[width=5cm]{figures/wavefunction.pdf}};
    }
    \visible<12->{
      \node[below] at (3, -0.8) {\includegraphics[width=5cm]{figures/na2cs4.pdf}};
    }
    \visible<13->{
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      {\hspace{0.5cm}\usebeamerfont{frametitle}\usebeamercolor[fg]{frametitle}{Loading}\\
        \includegraphics[width=3cm]{figures/single_viridis.png}};
      ...
      {\usebeamerfont{frametitle}\usebeamercolor[fg]{frametitle}{Cooling}\\
        \includegraphics[width=4.2cm]{figures/spectrum_nolabel_az.pdf}};
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \visible<3-4>{
        ...
        {\includegraphics[width=6cm]{figures/fb_molecules.pdf}\\
      ...
      \visible<6->{
        \node[below, text width=6cm, align=left] at (3.1, 4)
        {
          ...
          \includegraphics[width=3.5cm]{figures/Rb2_raman.png}\\
          {\footnotesize $\mathrm{Sr_2}$}
          {\usebeamercolor[fg]{frametitle}{\tiny PRL. 109, 115302 (2012)}}\\
          {\footnotesize $\mathrm{NaCs}$}
          {\usebeamercolor[fg]{frametitle}{\tiny \textbf{Y. Yu} et al. PRX. 9, 021039 (2019)}}\\
          \includegraphics[width=3.5cm]{figures/old_raman_transfer.pdf}
        };
      }
      \visible<7->{
  ...
  \begin{center}
    ...
    \begin{tikzpicture}
      ...
      \visible<4>{
        ...
        {
          {\usebeamercolor[fg]{frametitle}{\textbf{Near threshold states}}}
          \includegraphics[width=5.4cm]{figures/raman_vh.pdf}
        };
        \node[below, text width=5.4cm, align=center] (DeepPlot) at (8.13, 3.2)
        {
          {\usebeamercolor[fg]{frametitle}{\textbf{Deeply bound states}}}
          \includegraphics[width=5.4cm]{figures/raman_v0.pdf}
        };
...
\begin{frame}[t]{Experiment}
  \todo{
    Show one ASE filter data
    Talk about two possible reasons
    Show Laser spectrum
    Show Gamma vs Omega plot showing effect of ASE filter
    (mention that there's something I didn't say for the previous data
    since it's actually taken with one ASE filter)
    Show data that suggests power square scaling of molecular scattering rate.
  }
  \begin{center}
    \vspace{-0.9cm}
    \begin{tikzpicture}
      ...
      \visible<3> {
        \node[below] at (2.6, 4) {\includegraphics[width=5.5cm]{figures/fit_20200326_005204_raman_3322_2_damop_f.pdf}};
      }
      \visible<4-> {
        \node[below] at (2.6, 4) {\includegraphics[width=5.5cm]{figures/fit_20200326_005204_raman_3322_2_damop_f_text.pdf}};
      }
      \visible<2-4> {
      ...
      \visible<5-> {
        \node[below] at (2.6, -0.5) {\includegraphics[width=5.5cm]{figures/molecule_raman_rabi_annotate.pdf}};
      }
      \visible<6-> {
      ...
      \visible<6-7> {
        \node[below] at (-3.2, -0.3) {\includegraphics[width=5.3cm]{figures/fit_20200703_201618_raman15_3322_2_postdoc_2d_mol.pdf}};
      }
      \visible<8-> {
        \node[below] at (-3.2, -0.3) {\includegraphics[width=5cm]{figures/Timebase1038_20200702_094907.png}};
      }
    \end{tikzpicture}
  \end{center}
\end{frame}
  ...
  \begin{columns}
    ...
    \visible<6->{
      \begin{tikzpicture}
        ...
        {\includegraphics[height=1.5cm]{figures/kangkuen}\\\scriptsize Kang-Kuen Ni};

        %% Current member
        \node[below,align=center, execute at begin node=\setlength{\baselineskip}{7pt}] at (-1.5, -2.2)
        {\includegraphics[height=1.5cm]{figures/kenneth}\\\scriptsize Kenneth\\\scriptsize Wang};
        \node[below,align=center, execute at begin node=\setlength{\baselineskip}{7pt}] at (0, -2.2)
        {\includegraphics[height=1.5cm]{figures/jessie}\\\scriptsize Jessie\\\scriptsize Zhang};
        \node[below,align=center, execute at begin node=\setlength{\baselineskip}{7pt}] at (1.5, -2.2)
        {\includegraphics[height=1.5cm]{figures/lewis}\\\scriptsize Lewis\\\scriptsize Picard};
        \node[below,align=center, execute at begin node=\setlength{\baselineskip}{7pt}] at (3.0, -2.2)
        {\includegraphics[height=1.5cm]{figures/will}\\\scriptsize William\\\scriptsize Cairncross};

        %% Former member
        \node[below,align=center, execute at begin node=\setlength{\baselineskip}{7pt}] at (-1.5 + 0.375, -4.4)
        {\includegraphics[height=1.5cm]{figures/lee}\\\scriptsize Lee Liu\\\tiny Postdoc @JILA};
        \node[below,align=center, execute at begin node=\setlength{\baselineskip}{7pt}] at (0.75, -4.4)
        {\includegraphics[height=1.5cm]{figures/jon}\\\scriptsize Jonathan Hood\\\tiny Assnt Prof @Purdue};
        \node[below,align=center, execute at begin node=\setlength{\baselineskip}{7pt}] at (3 - 0.375, -4.4)
        {\includegraphics[height=1.5cm]{figures/nick}\\\scriptsize Nick Hutzler\\\tiny Assnt Prof @Caltech};

        %% Theory
        \node[below,align=center] at (0, -7.1) {Theory};
        \node[below,align=center, execute at begin node=\setlength{\baselineskip}{7pt}] at (1.7, -6.6)
        {\includegraphics[height=1.5cm]{figures/jeremy}\\\scriptsize Jeremy Hutson};
      \end{tikzpicture}
    }
  \end{columns}
\end{frame}
  ...
  \begin{columns}[t]
    ...
    \begin{center}
      \begin{tikzpicture}
        \visible<2> {
          \node at (0, 0)
          {\includegraphics[width=6cm]{figures/cs-histogram}};
        }
        \visible<3> {
          \node at (0, 0)
          {\includegraphics[width=5cm]{figures/na-noatom}};
        }
        \visible<4> {
...
\begin{frame}{Real Issue with Na: Light Shift}
  ...
  \begin{columns}
    \column{5.7cm}
    \begin{center}
      \only<-3>{\includegraphics[width=5.5cm]{figures/light-shift.png}}
      \only<4->{
        ...
        \end{block}
        \includegraphics[width=5cm]{figures/switching.png}
      }
    \end{center}
    \column{5.8cm}
    \begin{center}
      \begin{tikzpicture}
        \visible<2-4>{
          \node[align=center] at (0, 0) {Cs single atom imaging\\
            \includegraphics[width=5.5cm]{figures/det-vs-photon-dc2}};
        }
        \visible<3-5>{
        ...
        \visible<5->{
          \node[align=center] at (0, 0) {Cs single atom imaging\\
            \includegraphics[width=5.5cm]{figures/det-vs-photon-ac}};
        }
        \visible<6->{
          \node at (0, -4.5)
          {\includegraphics[width=4cm]{figures/single_viridis.png}};
        }
      \end{tikzpicture}
    \end{center}
  \end{columns}
...
\begin{frame}[t]{Na (1, -1) Cs (3, -3) Feshbach resonance}
  \only<1>{
    \begin{center}
      \includegraphics[height=7cm]{figures/chamber1_5.jpg}
    \end{center}
  }
  \only<2->{
    \begin{center}
      \includegraphics[width=10cm]{figures/fb.pdf}\\
      \vspace{0.5cm}
    \end{center}
  }
  \only<3->{
...
\begin{frame}[t]{\alt<-4>{Photoassociation (PA) Spectroscopy}{Electromagnetically Induced Transparency (EIT) Spectroscopy}}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \visible<3>{
        \node at (3, 3) {\includegraphics[width=8cm]{figures/pa-shallow_1b}};
      }
      \visible<4>{
        \node at (3, 3) {\includegraphics[width=8cm]{figures/pa-shallow}};
      }
      \visible<6>{
        \node at (4, 2.5) {\includegraphics[width=5cm]{figures/eit.png}};
      }
    \end{tikzpicture}
  \end{center}
\end{frame}
