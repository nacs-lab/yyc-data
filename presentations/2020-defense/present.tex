...
% You see, the atomic systems, built with, well, neutral atoms, are, well, too simple.
...
% These discrete levels exist for all the ground HF states as shown here.
% Now, we can drive between different ground HF states, say, with a Raman transitions,
% but due to the motional level,
% in additional to driving a "carrier" Raman transition
% at the normal resonance frequency like this,
...
% Moreover, not only is this useful for cooling the atoms,
...
% Of course, this sideband only remove a very limited amount of energy from the atoms
% and we have to go back to the original HF state to restart the process.
