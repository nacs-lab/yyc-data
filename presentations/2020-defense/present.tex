...
% * Next, also mentioned before, they should have a rich internal structure.
% % These allows more interesting dynamics to occure
% % and will also be our knobs to tune the systems. __(>>)__
...
% and we are not the only one that explore new options. __(>>)__
% In fact neutral atom isn't even the first system people used.
% There are many other choices for example like ions and Rydberg atoms. __(>>)__
% Nevertheless, I believe it is still worth investigating in new systems like what we do,
% because first, all of the existing systems still have their limitations __(>>)__
...
% This is done using an optical pumping step which is also the step that removes the entropy,
% if that's your preferred picture. __(>>)__
...
% and this explanation works out just as good. __(>>)__
