    ...
    \begin{tikzpicture}
      ...
      \visible<5>{
        \begin{scope}[shift={(3, 2)}]
          \draw[red,line width=1.6,mid arrow]
          ({-2.5 + 1.7 * cos(40)}, {-0.5 + 1.7 * sin(40)}) -- (-2.5, -0.5);
...
\begin{frame}
  \begin{center}
    \begin{tikzpicture}
      %% PI
      \node[align=center] at (-0.5, -0.9) {PI};
      ...
      \node[below,align=center, execute at begin node=\setlength{\baselineskip}{7.5pt}]
      at (-1.1, -6.6) {\includegraphics[height=1.5cm]{figures/acknowledgement_jon}\\
        \scriptsize Jonathan Hood\\\tiny AP @Purdue};
      \node[below,align=center, execute at begin node=\setlength{\baselineskip}{7.5pt}]
      at (0.6, -6.6) {\includegraphics[height=1.5cm]{figures/acknowledgement_nick}\\
