      ...
      \begin{block}{Trapping and Cooling of Atoms}
        ...
        \begin{columns}[T]
          \begin{column}{0.5\coltwowid}
            \vspace{2ex}
            \begin{tikzpicture}
              \node at (1, 12) {\textbf{Na axial Raman spectrum}};
              \node at (0, 6.5) {\includegraphics[width=0.48\coltwowid]{spectrum_nolabel_az}};
              \node at (1, 0) {\textbf{Cs Raman spectrum}};
              \node at (0, -6.5) {\includegraphics[width=0.48\coltwowid]{cs-raman}};
            \end{tikzpicture}
          \end{column}
          \begin{column}{0.49\coltwowid}
            \vspace{2ex}
