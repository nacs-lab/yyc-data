...
\begin{frame}
  \begin{columns}
    ...
    \begin{center}
      \begin{tikzpicture}
        \visible<4> {
          \path (0, 0) node[above,align=center] {Cs single atom imaging\\
            \includegraphics[width=6.5cm]{det-vs-photon-dc2.png}};
        }
        \visible<5-> {
          \path (0, 0) node[above,align=center] {Cs single atom imaging\\
            \includegraphics[width=6.5cm]{det-vs-photon-ac.png}};
        }
      \end{tikzpicture}
    \end{center}
  \end{columns}
