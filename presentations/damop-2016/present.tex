...
\begin{frame}
  \begin{columns}
    ...
    \begin{block}{Light shift}
      ...
      \item<3-> Inefficient cooling;\\
        Heating
      \item<4-> Reduced trap depth\\
        (for $\beta < 1$)
      \item<5-> Out of resonance
      \end{itemize}
    \end{block}
    \column{7cm}
    \begin{center}
      \begin{tikzpicture}
        ...
        \visible<6> {
          % TODO photon-vs-detuning plot
          \path (0, 1.5) node {Add photon-vs-detuning};
          % Maybe loading vs trap wavelength?
        }
      \end{tikzpicture}
    \end{center}
  \end{columns}
...
\begin{frame}
  \begin{columns}
    ...
    \begin{block}{Solution}
      \begin{itemize}
      \item<2-> Trap switching % TODO reference
      \item<3-> Out-of-phase resonant and trap light % TODO trace
