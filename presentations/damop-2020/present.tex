...
% Howver, this approach obviously rely on finding a good FB resonance so it is
    ...
    \visible<5->{
      ...
      \visible<6->{
        \node[below, text width=6cm, align=center] at (-3.6, -1)
        {
          ...
          \begin{itemize}
          \item $\mathrm{Rb_2}$ {\scriptsize 10.1126/science.287.5455.1016}\\
            \phantom{$\mathrm{Rb_2}$} {\scriptsize Phys. Rev. Lett. 93, 073002}
          \item $\mathrm{Sr_2}$ % TODO: reference
          \end{itemize}
        };
...
\begin{frame}[t]{Raman transfer}
  \begin{center}
    ...
    \begin{tikzpicture}
      ...
      \end{scope}
      \visible<2-3>{
        \node[below, text width=6cm, align=center] at (8.13, 6.8)
        {
      ...
      \visible<3>{
        \node[below, text width=6cm, align=center] at (8.13, 2.7)
        {
      ...
      \visible<4>{
        \node[below, text width=6cm, align=center] (ThresholdPlot) at (8.13, 7.5)
        {
          {\usebeamercolor[fg]{frametitle}{\textbf{Near threshold states}}}
          \includegraphics[width=5.3cm]{imgs/raman_vh.pdf}
        };
        \node[below, text width=6cm, align=center] (DeepPlot) at (8.13, 3.2)
        {
          {\usebeamercolor[fg]{frametitle}{\textbf{Deeply bound states}}}
          \includegraphics[width=5.3cm]{imgs/raman_v0.pdf}
        };
