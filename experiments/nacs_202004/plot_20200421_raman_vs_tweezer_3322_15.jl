...
const freq = [1623, 616.56, 595.80, 577.44, 483.50]
const freq_unc = [30, 0.21, 0.47, 0.13, 0.12]

const prefix = joinpath(@__DIR__, "imgs", "data_20200421_ramann_vs_tweezer_3322_15")
