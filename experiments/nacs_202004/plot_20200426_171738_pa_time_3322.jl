...
const inames = ["data_20200426_171738.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [([0.0, 2, 4, 10],
                [0.0, 40, 80, 120],
                [0.0, 40, 80, 160] .* 2,
                [0.0, 50, 100],
                [0.0, 160, 240],
...
const data_15a = datas_nacs[1][4]
const data_15m = datas_nacs[1][1]
const data_6a = datas_nacs[1][5]
const data_6m = datas_nacs[1][2]
const data_3a = datas_nacs[1][6]
const data_3m = datas_nacs[1][3]

const data_15cs = datas_cs[1][4]
const data_6cs = datas_cs[1][5]
const data_3cs = datas_cs[1][6]
const data_15na = [datas_na[1][4]; datas_na[1][1]]
const data_6na = [datas_na[1][5]; datas_na[1][2]]
const data_3na = [datas_na[1][6]; datas_na[1][3]]

const prefix = joinpath(@__DIR__, "imgs", "data_20200426_171738_pa_time_3322")
