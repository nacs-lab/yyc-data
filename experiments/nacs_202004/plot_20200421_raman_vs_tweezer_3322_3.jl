...
const tweezer = [668.35, 565, 560, 555, 503]
const freq = [488, 291.891, 287.282, 283.665, 264.912]
const freq_unc = [10, 0.038, 0.015, 0.017, 0.018]

const prefix = joinpath(@__DIR__, "imgs", "data_20200421_raman_vs_tweezer_3322_3")
