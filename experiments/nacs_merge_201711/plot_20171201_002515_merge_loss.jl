...
# data_na = NaCsData.select_count(params_a, logicals_a, gen_selector(true, false, true))
# data_cs = NaCsData.select_count(params_a, logicals_a, gen_selector(false, true, false))
# data_na_both = NaCsData.select_count(params_a, logicals_a, gen_selector(true, true, true))
# data_cs_both = NaCsData.select_count(params_a, logicals_a, gen_selector(true, true, false))
