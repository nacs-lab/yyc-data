...
const inames = ["data_20190113_152012.mat"]
...
fit_na_11 = fit_survival(model_cos_off, data_na_11, [0.9, 0.5, 13])
fit_na_10 = fit_survival(model_cos_off, data_na_10, [0.9, 0.4, 11])

const prefix = joinpath(@__DIR__, "imgs", "data_20190113_152012_depump_coprop_time")
...
text(9, 0.25, "\$\\tau_{\\pi\\ 1, 1}=$(fit_na_11.uncs[3])\\mu s\$", color="C0")
text(10, 0.1, "\$p_{1, 1}=$(fit_na_11.uncs[2])\$", color="C0")
text(4, 0.85, "\$\\tau_{\\pi\\ 1, 0}=$(fit_na_10.uncs[3])\\mu s\$", color="C1")
