...
const inames = ["data_20181227_105417.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [20:10.0:100]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20181227_105417_mot_t")

figure()
NaCsPlot.plot_loading_data(data_na, fmt="C0-")
grid()
ylim([0, 1])
title("Na loading")
