...
const inames = ["data_20190106_103817.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs_na = [14 .+ (-10:2:10)]
const specs_cs = [10 .+ (-10:2:10)]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20190106_103817_pushout_res")
