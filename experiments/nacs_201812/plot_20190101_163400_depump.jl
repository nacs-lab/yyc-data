...
text(9, 0.42, "\$\\tau_{2, 2}=$(fit_na_22.uncs[2])ms\$", color="C0")
text(9, 0.31, "\$\\tau_{2, 1}=$(fit_na_21.uncs[2] * 1000)\\mu s\$", color="C1")
text(9, 0.18, "\$r=$(fit_na_22.uncs[2] / fit_na_21.uncs[2])\$")
legend(fontsize="small")
grid()
ylim([0, 1])
xlim([0, 27])
