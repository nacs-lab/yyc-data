...
const by = -0.05 .+ linspace(-1.0, 1.0, 17)
const bz = 0.2 .+ linspace(-1.0, 1.0, 17)

const inames = ["data_20181231_163322.mat"]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20181231_163322_depump_b")
