...
const inames = ["data_20190113_143533.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs_na = [(-13 .+ linspace(-80, 80, 21),
                   -18.427e3 .+ linspace(-80, 80, 21))]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20190113_143533_depump_coprop")
