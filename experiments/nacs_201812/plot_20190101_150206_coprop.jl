...
const inames = ["data_20190101_150206.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs_na = [-200:16.0:200]
const specs_cs = [-80:8.0:120]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20190101_150206_coprop")
