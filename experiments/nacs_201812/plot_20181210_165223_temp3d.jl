...
const inames = ["data_20181210_165223.mat"]
...
const specs_cs = [OrderedDict(
    :az=>(-13.5 .+ (-15:2.0:15), 32 .+ (-15:2.0:15)),
    :rx=>(-136 .+ (-45:6.0:45), 134 .+ (-75:10.0:75)),
    :ry=>(-130 .+ (-45:6.0:45), 135 .+ (-60:8.0:60))
)]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20181210_165223_temp")
