...
const inames = ["data_20181218_201718.mat"]
...
data_cs_f115 = datas_cs[1][:f115]

const prefix = joinpath(@__DIR__, "imgs", "data_20181218_201718_ramsey_pulse_freq")
...
NaCsPlot.plot_survival_data(data_cs_f115, fmt="C3", label="-115kHz")
