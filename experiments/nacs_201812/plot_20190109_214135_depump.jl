...
const inames = ["data_20190109_214135.mat"]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20190109_214135_depump")
...
text(2, 0.42, "\$\\tau_{2, 2}=$(fit_na_22.uncs[2])ms\$", color="C0")
text(2, 0.31, "\$\\tau_{2, 1}=$(fit_na_21.uncs[2] * 1000)\\mu s\$", color="C1")
text(2, 0.18, "\$r=$(fit_na_22.uncs[2] / fit_na_21.uncs[2])\$")
...
text(100, 0.62, "\$\\tau_{4, 4}=$(fit_cs_44.uncs[2])ms\$", color="C0")
text(100, 0.51, "\$\\tau_{4, 3}=$(fit_cs_43.uncs[2] * 1000)\\mu s\$", color="C1")
text(100, 0.28, "\$r=$(fit_cs_44.uncs[2] / fit_cs_43.uncs[2])\$")
legend(fontsize="small")
grid()
ylim([0, 1])
xlim([0, 250])
