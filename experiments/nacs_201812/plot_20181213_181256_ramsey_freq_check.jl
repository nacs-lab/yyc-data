...
const inames = ["data_20181213_181256.mat"]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20181213_181256_ramsey_freq_check")

figure()
NaCsPlot.plot_survival_data(data_na[1], fmt="C0.", label="579 kHz")
plot(fit_1.plotx, fit_1.ploty, "C0-")
NaCsPlot.plot_survival_data(data_na[2], fmt="C1.", label="-24 kHz")
plot(fit_2.plotx, fit_2.ploty, "C1-")
text(1, 0.75, "\$\\nu_{579}=$(fit_1.uncs[3] * 1000)\$kHz", color="C0")
text(2, 0.05, "\$\\nu_{-24}=$(fit_2.uncs[3] * 1000)\$kHz", color="C1")
