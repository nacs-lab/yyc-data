...
const inames = ["data_20190130_180728.mat"]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20190130_180728_depump")
...
NaCsPlot.plot_survival_data(NaCsData.map_params((i, v)->v * 1000, data_cs_43),
                            fmt="C1.", label="4, 3\${}_{t\\times1000}\$")
plot(fit_cs_43.plotx .* 1000, fit_cs_43.ploty, "C1")
