...
const inames = ["data_20181218_164625.mat"]
...
data_cs_f110 = datas_cs[1][:f110]

const prefix = joinpath(@__DIR__, "imgs", "data_20181218_164625_ramsey_pulse_freq")

figure()
NaCsPlot.plot_survival_data(data_cs_f127, fmt="C0", label="-127kHz")
NaCsPlot.plot_survival_data(data_cs_f110, fmt="C1", label="-110kHz")
legend()
grid()
ylim([0, 1])
