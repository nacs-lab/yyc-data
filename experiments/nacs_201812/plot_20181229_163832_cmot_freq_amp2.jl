...
const inames = ["data_20181229_163832.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [1:(length(det) * length(amp2))]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20181229_163832_cmot_freq_amp2")
...
figure()
show_loading_image(det, amp2, data_na)
title("Na CMOT")
xlabel("Detuning (MHz)")
ylabel("Amplitude 2")
colorbar()
