...
const inames = ["data_20190103_102739.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs_cs = [([0, 0.5, 1, 2, 5, 10, 20, 50] .* 10,
...
const prefix = joinpath(@__DIR__, "imgs", "data_20190103_102739_depump")
...
text(200, 0.62, "\$\\tau_{4, 4}=$(fit_cs_44.uncs[2])ms\$", color="C0")
text(200, 0.51, "\$\\tau_{4, 3}=$(fit_cs_43.uncs[2] * 1000)\\mu s\$", color="C1")
text(200, 0.28, "\$r=$(fit_cs_44.uncs[2] / fit_cs_43.uncs[2])\$")
