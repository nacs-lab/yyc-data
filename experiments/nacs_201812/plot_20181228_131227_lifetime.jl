...
const inames = ["data_20181228_131227.mat"]
...
figure()
NaCsPlot.plot_survival_data(data_cs_hot, fmt="C0.")
plot(fit_cs_hot.plotx, fit_cs_hot.ploty)
text(5500, 0.35, "\$\\tau=$(fit_cs_hot.uncs[2] / 1000)\$s", color="C0")
grid()
ylim([0, 1])
xlim([0, 11000])
title("Cs Lifetime")
