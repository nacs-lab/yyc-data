...
const inames = ["data_20200108_103123.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [367.20 .+ (-100:10:100) .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200108_103123_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.7, 0.3, 367.2, 0.05])
...
title("306530.7 GHz, 8 mW, 10 ms")
# ylim([0.18, 0.42])
text(367.09, 0.356, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(367.09, 0.376, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
