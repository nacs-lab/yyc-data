...
const inames = ["data_20200120_163744.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [369.046 .+ [-200; -60:20:40; 200] .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200120_163744_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.7, 0.2, 369.046, 0.05])
...
title("306480.7 GHz, 16 mW, 0.5 ms")
# ylim([0.44, 0.66])
text(368.82, 0.555, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(368.82, 0.575, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
