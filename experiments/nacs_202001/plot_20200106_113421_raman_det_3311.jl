...
const inames = ["data_20200106_113421.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [(368.1175 .+ (-100:10:100) .* 1e-3)]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200106_113421_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.64, 0.3, 368.1175, 0.05])
...
title("306480.7 GHz, 4 mW, 50 ms")
text(368.0, 0.29, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
text(368.0, 0.25, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
