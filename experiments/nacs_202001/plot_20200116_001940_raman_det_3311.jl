...
const inames = ["data_20200116_001940.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [369.046 .+ [-200; -50:10:50; 200] .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200116_001940_raman_det_3311")
...
# ylim([0.18, 0.42])
text(368.82, 0.450, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(368.82, 0.465, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
