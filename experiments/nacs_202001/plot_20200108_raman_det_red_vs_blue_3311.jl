...
figure()
NaCsPlot.plot_survival_data(data_480′, fmt="C0.", label="306480.7 GHz")
plot((fit_480.plotx .- fit_480.param[3]) .* 1000, fit_480.ploty, "C0-")
NaCsPlot.plot_survival_data(data_530′, fmt="C1.", label="306530.7 GHz")
plot((fit_530.plotx .- fit_530.param[3]) .* 1000, fit_530.ploty, "C1-")
title("8 mW, 5 ms")
# # ylim([0.18, 0.42])
text(-136, 0.3, "\$f=$(fit_480.uncs[3])\$ MHz", color="C0", fontsize="small")
text(-136, 0.335, "\$\\Gamma=$(fit_480.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
text(16, 0.47, "\$f=$(fit_530.uncs[3])\$ MHz", color="C1", fontsize="small")
text(28, 0.505, "\$\\Gamma=$(fit_530.uncs[4] * 1000)\$ kHz", color="C1", fontsize="small")
