...
const inames = ["data_20200130_012232.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [364.5 .+ (-3000:200:3000) .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200130_012232_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.7, 0.2, 364.5, 0.2])
...
# ylim([0.44, 0.66])
text(361, 0.25, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(361, 0.28, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
