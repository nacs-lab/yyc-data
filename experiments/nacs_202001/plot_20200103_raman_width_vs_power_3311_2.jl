...
const prefix = joinpath(@__DIR__, "imgs", "data_20200103_raman_width_vs_power_3311_2")
...
text(8.7, 7, "\$\\Gamma=a \\cdot P\$", color="C0")
text(5.3, 1.3, "\$a=$(fit_pwr1.uncs[1]) \\mathrm{kHz}\\cdot\\mathrm{mW}^{-1}\$", color="C0")
text(0.1, 31, "\$\\Gamma=a \\cdot P^n\$", color="C2")
text(0.15, 19, ("\$a=$(fit_pwr.uncs[1])\$\n" *
