...
const inames = ["data_20200118_005027.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [298.678 .+ [-50; -20:4:20; 50] .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200118_005027_raman_det_4422")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.7, 0.2, 298.678, 0.05])
...
title("306480 GHz, 8 mW, 0.75 ms")
# ylim([0.18, 0.42])
text(298.62, 0.455, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(298.62, 0.480, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
