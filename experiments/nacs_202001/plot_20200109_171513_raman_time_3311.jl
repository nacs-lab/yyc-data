...
const inames = ["data_20200109_171513.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [[0, 0.5, 1, 1.5, 2, 2.5, 3.5, 4.5, 5.5, 7, 10, 15, 20]]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200109_171513_raman_time_3311")
...
title("306550.7 GHz, 8 mW, 367.505 MHz")
grid()
xlabel("Time (ms)")
