...
const inames = ["data_20200130_132823.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [365.5 .+ (-3000:300:3000) .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200130_132823_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.7, 0.2, 365, 0.5])
...
# ylim([0.44, 0.66])
text(362, 0.305, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(362, 0.28, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
