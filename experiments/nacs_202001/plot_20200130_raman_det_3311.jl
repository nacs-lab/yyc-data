...
const inames = ["data_20200130_203116.mat",
                "data_20200130_233324.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int),
                 typemax(Int)]
const specs = [365.5 .+ [-8000; -3000; -2000:500:2000; 3000; 8000] .* 1e-3,
               365.5 .+ [-8000; -3000; -2000:500:2000; 3000; 8000] .* 1e-3]
...
const data_nacs = [datas_nacs[1]; datas_nacs[2]]

const prefix = joinpath(@__DIR__, "imgs", "data_20200130_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, data_nacs, [0.7, 0.2, 365.5, 1])
...
title("306520 GHz, 16 mW, 4 ms")
# ylim([0.44, 0.66])
text(356, 0.39, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(356, 0.375, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
