...
const inames = ["data_20200106_194352.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [[0, 0.1, 0.2, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2, 2.5, 3.5, 4.5, 5] .* 3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200106_194352_raman_time_3311")
...
xlim([0, 15.5])
text(5, 0.6, "\$\\tau=$(fit1.uncs[3])\$ ms", color="C0")
# legend(fontsize="small", loc="lower right")
title("306480.7 GHz, 4 mW, 368.126 MHz")
grid()
xlabel("Time (ms)")
