...
const inames = ["data_20200129_172829.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [365 .+ (-960:120:960) .* 4e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200129_172829_raman_det_3311")
...
title("306520 GHz, 16 mW, 8 ms")
# ylim([0.44, 0.66])
text(361, 0.48, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(361, 0.50, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
