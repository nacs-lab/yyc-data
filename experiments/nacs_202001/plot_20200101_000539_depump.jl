...
const inames = ["data_20200101_000539.mat"]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200101_000539_depump")
...
NaCsPlot.plot_survival_data(NaCsData.map_params((i, v)->v * 2000, data_cs_43),
                            fmt="C1.", label="4, 3\${}_{t\\times2000}\$")
plot(fit_cs_43.plotx .* 2000, fit_cs_43.ploty, "C1")
text(60, 0.25, "\$\\tau_{4, 4}=$(fit_cs_44.uncs[1])ms\$", color="C0")
text(53, 0.14, "\$\\tau_{4, 3}=$(fit_cs_43.uncs[2] * 2000)\\mu s\$", color="C1")
