...
const inames = ["data_20200122_114854.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [367.52 .+ [-300; -50:10:50; 300] .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200122_114854_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.7, 0.2, 367.51, 0.05])
...
title("306530.7 GHz, 4 mW, 18 ms")
# ylim([0.44, 0.66])
text(367.18, 0.525, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(367.18, 0.545, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
