...
const inames = ["data_20200103_200743.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [368.433 .+ [-80; -40:5:40; 80] .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200103_200743_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.7, 0.3, 368.443, 0.05])
...
# ylim([0.18, 0.42])
text(368.339, 0.549, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(368.339, 0.564, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
legend(fontsize="small", loc="lower right")
grid()
title("306480.7 GHz, 8 mW, 0.75 ms")
