...
const inames = ["data_20200131_235704.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [366.2 .+ [-6000; -1200; -800; -500:100:500; 800; 1200; 6000] .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200131_235704_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.7, 0.2, 366.2, 0.2])
...
title("306524 GHz, 16 mW, 4 ms")
# ylim([0.44, 0.66])
text(359.4, 0.37, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(359.4, 0.39, "\$\\Gamma=$(fit1.uncs[4])\$ MHz", color="C0", fontsize="small")
