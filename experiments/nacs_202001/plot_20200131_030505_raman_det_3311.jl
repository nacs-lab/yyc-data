...
const inames = ["data_20200131_030505.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [365.5 .+ [-4000; -1500; -1000:250:1000; 1500; 4000] .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200131_030505_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.7, 0.2, 365.5, 0.2])
...
title("306515 GHz, 16 mW, 4 ms")
# ylim([0.44, 0.66])
text(361, 0.32, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(361, 0.3, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
