...
const inames = ["data_20200102_001120.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [(368.883 .+ (-60:6:60) .* 1e-3,
                368.883 .+ (-60:6:60) .* 1e-3)]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200102_001120_raman_det_3311")
