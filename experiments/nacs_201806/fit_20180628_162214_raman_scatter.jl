...
const iname_a = joinpath(@__DIR__, "data", "data_20180628_162214.mat")
...
const spec = OrderedDict(
    :f1_diagonal=>[4, 8, 16, 32, 64, 128, 256],
    :f2_diagonal=>[4, 8, 16, 32, 64, 128, 256],
    :f1_up=>[4, 8, 16, 32, 64, 128, 256],
    :f2_counterop=>[4, 8, 16, 32, 64, 128, 256],
    :f1_down=>[4, 8, 16, 32, 64, 128, 256],
    :t0=>[0],
)
...
const prefix = joinpath(@__DIR__, "imgs", "data_20180628_162214_raman_scatter")
