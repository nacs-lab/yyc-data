...
const iname_paaom = joinpath(@__DIR__, "data", "paaom_20190511.csv")
const data_paaom = readdlm(iname_paaom, ',', Float64, skipstart=1)
const iname_padpaom = joinpath(@__DIR__, "data", "padpaom_20190511.csv")
const data_padpaom = readdlm(iname_padpaom, ',', Float64, skipstart=1)
const iname_padpaom2 = joinpath(@__DIR__, "data", "padpaom2_20190511.csv")
...
const prefix = joinpath(@__DIR__, "imgs", "data_tweezer_20190511")
