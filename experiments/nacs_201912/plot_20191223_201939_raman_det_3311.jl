...
const inames = ["data_20191223_201939.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [367.385 .+ (-225:45:225) .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20191223_201939_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.5, 0.1, 367.4, 0.05], use_unc=false)
...
ylim([0.3, 0.58])
text(367.14, 0.53, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
grid()
