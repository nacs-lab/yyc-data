...
const inames = ["data_20191224_140604.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [367.385 .+ (-405:45:225) .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20191224_140604_raman_det_3311")
...
ylim([0.2, 0.65])
text(366.95, 0.3, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
grid()
