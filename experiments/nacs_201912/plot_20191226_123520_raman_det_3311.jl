...
const inames = ["data_20191226_123520.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [367.165 .+ (-250:50:250) .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20191226_123520_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.49, 0.1, 367.2, 0.1])
...
ylim([0.35, 0.505])
text(366.93, 0.483, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
grid()
