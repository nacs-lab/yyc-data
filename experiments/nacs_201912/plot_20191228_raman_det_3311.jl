...
const inames = ["data_20191228_161733.mat",
                "data_20191228_182258.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int),
                 typemax(Int)]
const specs = [(368376 .+ (-90:15:90)) .* 1e-3,
               (368481 .+ (-90:15:45)) .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20191228_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, data_nacs, [0.4, 0.15, 368.43, 0.05])
...
ylim([0.21, 0.44])
text(368.27, 0.22, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
grid()
