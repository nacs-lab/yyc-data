...
const inames = ["data_20191225_165424.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [367.654 .+ (-120:15:120) .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20191225_165424_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.5, 0.1, 367.64, 0.05])
...
ylim([0.34, 0.55])
text(367.56, 0.52, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
grid()
