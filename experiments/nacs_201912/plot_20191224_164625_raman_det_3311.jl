...
const inames = ["data_20191224_164625.mat"]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20191224_164625_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.6, 0.2, 367.6, 0.05])
...
ylim([0.3, 0.75])
text(367.3, 0.68, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
grid()
