...
const inames = ["data_20191219_230220.mat",
                "data_20191220_102713.mat"]
...
const data_cs_lo_diagonal = [datas_cs[1][:t0]; datas_cs[1][:lo_diagonal]; datas_cs[2][:t0]]
const data_cs_hi_diagonal = [datas_cs[1][:t0]; datas_cs[1][:hi_diagonal]; datas_cs[2][:t0]]
const data_cs_up = [datas_cs[1][:t0]; datas_cs[1][:up]; datas_cs[2][:t0]]
const data_cs_counterop = [datas_cs[1][:t0]; datas_cs[1][:counterop]; datas_cs[2][:t0]]
const data_cs_down = [datas_cs[1][:t0]; datas_cs[1][:down]; datas_cs[2][:t0]]

const data_na_lo_diagonal = [datas_na[1][:t0]; datas_na[1][:lo_diagonal]; datas_na[2][:t0]]
const data_na_hi_diagonal = [datas_na[1][:t0]; datas_na[1][:hi_diagonal]; datas_na[2][:t0]]
const data_na_up = [datas_na[1][:t0]; datas_na[1][:up]; datas_na[2][:t0]]
const data_na_counterop = [datas_na[1][:t0]; datas_na[2][:t0]; datas_na[2][:counterop]]
const data_na_down = [datas_na[1][:t0]; datas_na[1][:down]; datas_na[2][:t0]; datas_na[2][:down]]
