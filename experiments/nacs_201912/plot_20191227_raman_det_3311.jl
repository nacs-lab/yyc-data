...
const inames = ["data_20191227_234830.mat",
                "data_20191228_110712.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int),
                 typemax(Int)]
const specs = [367.97 .+ (-200:20:200) .* 1e-3,
               367.97 .+ (-80:20:40) .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20191227_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, data_nacs, [0.4, 0.1, 367.98, 0.05])
...
ylim([0.25, 0.45])
text(367.74, 0.26, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
grid()
