...
const inames = ["data_20191225_133022.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [367.745 .+ (-405:45:225) .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20191225_133022_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.55, 0.15, 367.58, 0.05])
...
ylim([0.2, 0.6])
text(367.3, 0.55, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
grid()
