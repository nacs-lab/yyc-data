...
const inames = ["data_20191227_190425.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [368.17 .+ (-120:20:120) .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20191227_190425_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.45, 0.15, 368.16, 0.05])
...
ylim([0.27, 0.51])
text(368.09, 0.47, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
grid()
