...
const inames = ["data_20200614_110448.mat",
                "data_20200619_091358.mat",
                "data_20200619_141950.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [idx->(idx < 24840 || idx > 28980),
                 typemax(Int),
                 16320]
...
const data_pa_na = [datas_na[2][5]; datas_na[2][2]; datas_na[3][5]; datas_na[3][2]]
const data_pa_cs = [datas_cs[2][5]; datas_cs[3][5]]
const data_pa_a = [datas_nacs[2][5]; datas_nacs[3][5]]
const data_pa_m = [datas_nacs[2][2]; datas_nacs[3][2]]

const data_fit = [NaCsData.map_params((i, v) -> (1, 487.48, v, 1), data_nacs_00);
...
const prefix = joinpath(@__DIR__, "imgs", "fit_20200614_110448_raman_3322_2")
...
fit = fit_survival(model, data_fit, [487.48, 2π * 1.5, 0, 2π / 0.2, 0, 0, 0.1,
                                     0.3, 0.8, 0.3, 0.3, 0.3],
...
const plot_freq_lo = 487.48 - 4
const plot_freq_hi = 487.48 + 4
...
title("Time")
text(0.10, 0.14, ("\$f_{res}=$(uncs_1[3] / 1000 + 770)\$ MHz\n" *
