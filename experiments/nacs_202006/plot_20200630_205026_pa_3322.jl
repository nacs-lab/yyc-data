...
const names_files = ["names_20200630_205026.mat"]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200630_205026_pa_3322")
...
NaCsPlot.plot_survival_data(datas[1][:, 1], fmt="C0.-", label="0 ms")
NaCsPlot.plot_survival_data(datas[1][:, 2], fmt="C1.-", label="2 ms")
...
# figure()
# NaCsPlot.plot_survival_data(datas_cscs[1][:, 2], fmt="C2.-", label="Cs")
# NaCsPlot.plot_survival_data(datas_nana[1][:, 2], fmt="C1.-", label="Na")
# grid()
# ylim([0, 1])
# # xlim([495.95, 612.29])
# legend(fontsize="small")
