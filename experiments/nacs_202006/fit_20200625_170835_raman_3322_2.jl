...
const data_fit = [NaCsData.map_params((i, v) -> (1, -102.0, v, 1), data_nacs_00);
                  NaCsData.map_params((i, v) -> (1, v, 0.20, 1), data_nacs_20);
                  NaCsData.map_params((i, v) -> (1, v, 0.40, 1), data_nacs_40);
                  NaCsData.map_params((i, v) -> (1, v, 0.80, 1), data_nacs_80);
                  NaCsData.map_params((i, v) -> (1, -102.0, v, 1), data_nacs_t);
...
const prefix = joinpath(@__DIR__, "imgs", "fit_20200625_170835_raman_3322_2")
...
fit = fit_survival(model, data_fit, [-102.0, 2π * 1.5, 0, 2π / 0.2, 0, 0, 0.1,
