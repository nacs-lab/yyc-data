...
const data_pa_na = [datas_na[3][6]; datas_na[3][3]; datas_na[4][6]; datas_na[4][3]]
const data_pa_cs = [datas_cs[3][6]; datas_cs[4][6]]
const data_pa_a = [datas_nacs[3][6]; datas_nacs[4][6]]
const data_pa_m = [datas_nacs[3][3]; datas_nacs[4][3]]

const data_fit = [NaCsData.map_params((i, v) -> (1, 347.2, v, 1), data_nacs_00);
                  NaCsData.map_params((i, v) -> (1, v, 0.50, 1), data_nacs_50);
                  NaCsData.map_params((i, v) -> (1, v, 1.01, 1), data_nacs_101);
                  NaCsData.map_params((i, v) -> (1, 347.2, v, 1), data_nacs_t);
...
const prefix = joinpath(@__DIR__, "imgs", "fit_20200618_173603_raman_3322_2")
...
fit = fit_survival(model, data_fit, [347.2, 2π * 1.0, 0, 2π * 0.3, 0, 0, 0.2,
