...
const iname_1040 = joinpath(@__DIR__, "data", "wp_1040_20191029.csv")
const data_1040 = readdlm(iname_1040, ',', Float64, skipstart=1)
const iname_1550 = joinpath(@__DIR__, "data", "wp_1550_20191029.csv")
const data_1550 = readdlm(iname_1550, ',', Float64, skipstart=1)

const prefix = joinpath(@__DIR__, "imgs", "data_wp_20191029")
...
grid()
ylim([0, ylim()[2]])
text(-2, 5, "\$a+b\\cdot\\sin(2(\\theta - \\theta_0))\$", fontsize=18, color="C0")
