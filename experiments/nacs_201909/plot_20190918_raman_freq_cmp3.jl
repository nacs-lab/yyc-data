...
const prefix = joinpath(@__DIR__, "imgs", "data_20190918_raman_freq")
...
fit3 = fit_survival(model_lorentzian, datas_nacs[3], [0.7, 0.3, 732, 0.5])
...
NaCsPlot.plot_survival_data(datas_nacs[3], fmt="C2.", label="0918")
plot(fit3.plotx, fit3.ploty, "C2-")
text(732.05, 0.795, "\$\\Gamma_{0910}=$(fit1.uncs[4])\$ kHz", color="C0", fontsize="small")
text(732, 0.765, "\$f_{0910}=$(fit1.uncs[3])\$ kHz", color="C0", fontsize="small")
text(731.05, 0.73, "\$\\Gamma_{0912}=$(fit2.uncs[4])\$ kHz", color="C1", fontsize="small")
text(731, 0.7, "\$f_{0912}=$(fit2.uncs[3])\$ kHz", color="C1", fontsize="small")
text(732.05, 0.33, "\$\\Gamma_{0918}=$(fit3.uncs[4])\$ kHz", color="C2", fontsize="small")
text(732, 0.30, "\$f_{0918}=$(fit3.uncs[3])\$ kHz", color="C2", fontsize="small")
