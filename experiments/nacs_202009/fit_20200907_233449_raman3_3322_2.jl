...
const data_fit = [NaCsData.map_params((i, v) -> (1, 284.1, v, 1), data_nacs_00);
                  NaCsData.map_params((i, v) -> (1, v, 1.10, 1), data_nacs_110);
                  NaCsData.map_params((i, v) -> (1, v, 2.20, 1), data_nacs_220);
                  NaCsData.map_params((i, v) -> (1, 284.1, v, 1), data_nacs_t);
...
const prefix = joinpath(@__DIR__, "imgs", "fit_20200907_233449_raman3_3322_2")
...
fit = fit_survival(model, data_fit, [284.1, 2π * 0.3, 0, 2π * 0.3, 0, 0, 0.2,
...
const plot_freq_lo = 284.1 - 1.6
const plot_freq_hi = 284.1 + 1.6
...
NaCsPlot.plot_survival_data([data_nacs_00; data_nacs_t], fmt="C0.", label="770.2841 MHz")
plot(plot_time, model_2d.(plot_time, 284.1, (param_1,)), "C0")
title("Time")
text(0.90, 0.16, ("\$f_{res}=$(uncs_1[3] / 1000 + 770)\$ MHz\n" *
