...
const inames = ["data_20200919_143845.mat",
                "data_20200920_015442.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int),
                 typemax(Int)]
const specs = [([0.0], # 15 mW, 0 ms
                576.2 .+ (-7:1.4:7), # 15 mW, 0.13 ms
                572.6 .+ (-11:2.2:11), # 15 mW, 0.26 ms
                [0.02, 0.04, 0.07, 0.085, 0.10, 0.13, 0.145, 0.16, 0.175, 0.19, 0.22,
                 0.25, 0.28, 0.31, 0.34, 0.37, 0.40, 0.43] .* 1.6 .- 0.01, # 15 mW, 770.5762 MHz
                ),
               ([0.0, 2, 4, 10],
                [0.0, 20, 40, 80, 120],
                [0.0, 20, 40, 80, 160] .* 2,
...
const prefix = joinpath(@__DIR__, "imgs", "fit_20200919_143845_raman15_3322_2")
...
fit = fit_survival(model, data_fit, [576.2, 2π * 1.5, 0, 2π / 0.2, 0, 0, 0.2,
...
const plot_freq_lo = 576.2 - 12
const plot_freq_hi = 576.2 + 12
...
plot(plot_freq, model_2d.(0.12, plot_freq, (param_1,)), "C1")
NaCsPlot.plot_survival_data(data_nacs_25, fmt="C2.", label="0.25 ms")
plot(plot_freq, model_2d.(0.25, plot_freq, (param_1,)), "C2")
...
subplot(2, 2, 2)
const plot_time = linspace(0, 0.7, 1000)
NaCsPlot.plot_survival_data([data_nacs_00; data_nacs_t], fmt="C0.", label="770.5762 MHz")
plot(plot_time, model_2d.(plot_time, 576.2, (param_1,)), "C0")
title("Time")
text(0.10, 0.19, ("\$f_{res}=$(uncs_1[3] / 1000 + 770)\$ MHz\n" *
