...
const data_fit = [NaCsData.map_params((i, v) -> (490.131, v, 1), data_nacs_00);
                  NaCsData.map_params((i, v) -> (v, 0.22, 1), data_nacs_22);
                  NaCsData.map_params((i, v) -> (v, 0.45, 1), data_nacs_45);
                  NaCsData.map_params((i, v) -> (490.131, v, 1), data_nacs_t)]

const prefix = joinpath(@__DIR__, "imgs", "fit_20200809_202331_raman15_3322")
...
fit = fit_survival(model, data_fit, [490.0, 2π * 1.5, 0, 2π / 0.2, 0.1, 0.3],
