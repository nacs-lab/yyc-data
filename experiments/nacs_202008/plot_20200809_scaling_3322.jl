...
const powers = [15, 6, 3]
const omega_r = [2.118, 0.662, 0.275] # kHz
const omega_r_unc = [0.036, 0.016, 0.021]
const gamma_m = [0.700, 0.227, 0.159] # kHz
const gamma_m_unc = [0.045, 0.020, 0.023]
const gamma_a = [32.5, 2.77, 0.573] # Hz
const gamma_a_unc = [3.1, 0.27, 0.078]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200809_scaling_3322")
...
text(6.4, 0.4, "\$n=$(fit_omega_r_p.uncs[2])\$", color="C2")
legend()
grid()
xscale("log")
yscale("log")
...
text(5.7, 0.05, "\$n=$(fit_gamma_m_p.uncs[2])\$", color="C2")
legend()
grid()
xscale("log")
yscale("log")
...
text(5.3, 1.0, "\$n=$(fit_gamma_a_p.uncs[2])\$", color="C2")
legend()
grid()
xscale("log")
yscale("log")
