...
const inames = ["data_20200830_183835.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [([0.0], # 6 mW, 0 ms
...
const data_nacs_50 = datas_nacs[1][2] # Survival 1
const data_nacs_100 = datas_nacs[1][3] # Survival 1

const data_pa_na = [datas_na[1][5 + 4]; datas_na[1][2 + 4]]
const data_pa_cs = datas_cs[1][5 + 4]
const data_pa_a = datas_nacs[1][5 + 4]
const data_pa_m = datas_nacs[1][2 + 4]

const data_fit = [NaCsData.map_params((i, v) -> (1, 327.55, v, 1), data_nacs_00);
                  NaCsData.map_params((i, v) -> (1, v, 0.50, 1), data_nacs_50);
                  NaCsData.map_params((i, v) -> (1, v, 1.0, 1), data_nacs_100);
                  NaCsData.map_params((i, v) -> (1, 327.55, v, 1), data_nacs_t);
...
const prefix = joinpath(@__DIR__, "imgs", "fit_20200830_183835_raman6_3322_2")
...
fit = fit_survival(model, data_fit, [327.55, 2π * 1.5, 0, 2π / 0.2, 0, 0, 0.2,
...
const plot_freq_lo = 327.55 - 3.2
const plot_freq_hi = 327.55 + 3.2
...
NaCsPlot.plot_survival_data(data_nacs_50, fmt="C1.", label="0.5 ms")
plot(plot_freq, model_2d.(0.50, plot_freq, (param_1,)), "C1")
NaCsPlot.plot_survival_data(data_nacs_100, fmt="C2.", label="1.0 ms")
plot(plot_freq, model_2d.(1.0, plot_freq, (param_1,)), "C2")
...
subplot(2, 2, 2)
const plot_time = linspace(0, 1.57, 1000)
NaCsPlot.plot_survival_data([data_nacs_00; data_nacs_t], fmt="C0.", label="770.32755 MHz")
plot(plot_time, model_2d.(plot_time, 327.55, (param_1,)), "C0")
title("Time")
text(0.30, 0.21, ("\$f_{res}=$(uncs_1[3] / 1000 + 770)\$ MHz\n" *
...
const img_time = linspace(0, 1.5, 201)
