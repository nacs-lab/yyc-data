...
const iname_paaom = joinpath(@__DIR__, "data", "cs_tweezer_paaom_20191203.csv")
const data_paaom = readdlm(iname_paaom, ',', Float64, skipstart=1)
const iname_padpaom = joinpath(@__DIR__, "data", "cs_tweezer_padpaom_20191203.csv")
const data_padpaom = readdlm(iname_padpaom, ',', Float64, skipstart=1)
const iname_padpaom2 = joinpath(@__DIR__, "data", "cs_tweezer_padpaom2_20191203.csv")
...
const prefix = joinpath(@__DIR__, "imgs", "cs_tweezer_20191203")
...
ylim([0, ylim()[2]])
text(0.3, 7, "\$a_1\\cdot\\sin(b_1\\cdot\\sin^2(c_1\\cdot AMP))\$", fontsize=18, color="C0")
...
text(0.002, 22.5, "\$a_2\\cdot\\sin^4(b_2\\cdot AMP)\$", fontsize=18, color="C0")
text(0.006, 28, params_strs2(fit_padpaom, "_2"), fontsize=20, color="C0")
text(0.585, 16, "\$a_3\\cdot\\cos^4(b_3\\cdot AMP)\$", fontsize=18, color="C1")
text(0.62, 4, params_strs2(fit_padpaom2, "_3"), fontsize=20, color="C1")
xlabel("PADPAOM/AMP")
ylabel("Power (mW)")
