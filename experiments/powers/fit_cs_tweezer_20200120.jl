...
const iname_paaom = joinpath(@__DIR__, "data", "cs_tweezer_paaom_20200120.csv")
const data_paaom = readdlm(iname_paaom, ',', Float64, skipstart=1)
const iname_padpaom = joinpath(@__DIR__, "data", "cs_tweezer_padpaom_20200120.csv")
const data_padpaom = readdlm(iname_padpaom, ',', Float64, skipstart=1)
const iname_padpaom2 = joinpath(@__DIR__, "data", "cs_tweezer_padpaom2_20200120.csv")
...
const prefix = joinpath(@__DIR__, "imgs", "cs_tweezer_20200120")
