...
const det = 0:-1.0:-25
const amp = linspace(0, 1, 21)

const inames = ["data_20190725_002911.mat"]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20190725_002911_cmot")
...
figure()
show_loading_image(det, amp, data_na)
title("Na loading")
xlabel("CMOT Detuning (MHz)")
ylabel("CMOT Amplitude 2")
colorbar()
