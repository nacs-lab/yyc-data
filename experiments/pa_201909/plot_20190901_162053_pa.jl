...
const names_files = ["names_20190901_162053.mat",
                     "names_20190901_222839.mat"]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20190901_162053_pa")

fit = fit_survival(model_lorentzian, datas[1], [0.7, 0.35, 920, 50])
...
text(777, 0.31, "\$\\Gamma=$(fit.uncs[4])\$ MHz", color="C0", fontsize="small")
text(777, 0.26, "\$f=$(fit.uncs[3])\$ MHz", color="C0", fontsize="small")
grid()
ylim([0.25, 0.9])
# xlim([495.95, 496.29])
