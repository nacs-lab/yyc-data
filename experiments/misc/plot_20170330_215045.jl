...
const iname = joinpath(@__DIR__, "data", "data_20170330_215045.csv")
...
Params3 = [linspace(-18.55, -18.58, 11); linspace(-18.42, -18.45, 11)]
Params4 = [linspace(10, 50, 11);]
Params5 = [linspace(20, 60, 11);]
Params6 = [linspace(40, 200, 13);]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20170330_215045")
