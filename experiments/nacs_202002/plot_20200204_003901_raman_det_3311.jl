...
const inames = ["data_20200204_003901.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [368.082 .+ [-100; -12; -10:1:10; 12; 100] .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200204_003901_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.7, 0.2, 368.082, 0.2])
...
title("306490.7 GHz, 2 mW, 8 ms")
# ylim([0.44, 0.66])
text(367.965, 0.48, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(367.965, 0.50, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
