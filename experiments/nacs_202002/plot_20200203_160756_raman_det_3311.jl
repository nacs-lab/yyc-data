...
const inames = ["data_20200203_160756.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [368.3576 .+ (-35:5:35) .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200203_160756_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.7, 0.2, 368.3576, 0.2])
...
title("306490.7 GHz, 4 mW, 4 ms")
# ylim([0.44, 0.66])
text(368.32, 0.39, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(368.32, 0.42, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
