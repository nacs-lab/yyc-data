...
const inames = ["data_20200227_115624.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs_na = [([0, 0.01, 0.02, 0.05, 0.1, 0.2, 0.4] .* 0.2,
                   [0, 0.5, 1, 2, 5, 10, 20, 40] ./ 5)]
const specs_cs = [([0, 0.01, 0.02, 0.05, 0.1, 0.2, 0.4] .* 0.75,
                   [0, 0.5, 1, 2, 5, 10, 20, 50] .* (2.5 * 9))]
...
data_cs_44 = datas_cs[1][2]
data_cs_43 = datas_cs[1][1]
data_na_22 = datas_na[1][2]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200227_115624_depump")
...
NaCsPlot.plot_survival_data(NaCsData.map_params((i, v)->v * 3000, data_cs_43),
                            fmt="C1.", label="4, 3\${}_{t\\times3000}\$")
plot(fit_cs_43.plotx .* 3000, fit_cs_43.ploty, "C1")
text(60, 0.25, "\$\\tau_{4, 4}=$(fit_cs_44.uncs[2])ms\$", color="C0")
text(53, 0.14, "\$\\tau_{4, 3}=$(fit_cs_43.uncs[2] * 3000)\\mu s\$", color="C1")
