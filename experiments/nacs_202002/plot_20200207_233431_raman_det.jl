...
const inames = ["data_20200207_233431.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [304.6 .+ [-500:50:500;] .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200207_233431_raman_det")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.7, 0.2, 304.6, 0.2])
...
title("306490 GHz, 16 mW, 0.5 ms")
# ylim([0.44, 0.66])
text(304.24, 0.8, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(304.34, 0.7, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
