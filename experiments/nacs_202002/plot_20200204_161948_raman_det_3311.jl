...
const inames = ["data_20200204_161948.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [367.933 .+ [-10:1:10;] .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200204_161948_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.7, 0.2, 367.935, 0.2])
...
# ylim([0.44, 0.66])
text(367.922, 0.48, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(367.922, 0.50, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
