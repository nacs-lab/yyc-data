...
const inames = ["data_20200214_230207.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [([0, 1, 2, 5, 10, 25, 50, 100, 200] .* 2.0,
                [0, 1, 2, 5, 10, 25, 50, 100, 200] .* 5.0)]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200214_230207_raman_time_4422")
...
xlim([0, 1100])
text(80, 0.15, "\$\\tau_{16}=$(fit1.uncs[2])\$ ms", color="C0")
text(500, 0.36, "\$\\tau_{8}=$(fit2.uncs[2] / 1000)\$ s", color="C1")
