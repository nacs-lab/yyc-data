...
const inames = ["data_20200202_180011.mat",
                "data_20200202_235631.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int),
                 typemax(Int)]
const specs = [(366.2e3 .+ (-2000:400:2000)) .* 1e-3,
               (367e3 .+ [-2000; -800; -600; -400:100:400; 600; 800; 2000]) .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200202_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, data_nacs, [0.5, 0.1, 367, 0.2])
...
title("306522 GHz, 8 mW, 12 ms")
# ylim([0.44, 0.66])
text(364, 0.40, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(364, 0.42, "\$\\Gamma=$(fit1.uncs[4])\$ MHz", color="C0", fontsize="small")
