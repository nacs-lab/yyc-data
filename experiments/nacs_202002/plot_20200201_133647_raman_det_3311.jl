...
const inames = ["data_20200201_133647.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [366.2 .+ [-8000; -2000; -1500:300:1500; 2000; 4000] .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200201_133647_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.7, 0.2, 366, 0.2])
...
title("306522 GHz, 16 mW, 4 ms")
# ylim([0.44, 0.66])
text(359, 0.42, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(359, 0.4, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
