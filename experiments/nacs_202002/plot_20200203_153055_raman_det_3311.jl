...
const inames = ["data_20200203_153055.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [368.8889 .+ (-70:10:70) .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200203_153055_raman_det_3311")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.7, 0.2, 368.8889, 0.2])
...
title("306490.7 GHz, 8 mW, 2 ms")
# ylim([0.44, 0.66])
text(368.808, 0.30, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(368.808, 0.33, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
