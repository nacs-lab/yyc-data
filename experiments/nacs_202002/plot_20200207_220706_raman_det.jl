...
const inames = ["data_20200207_220706.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [300.51 .+ [-80:10:80;] .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200207_220706_raman_det")
...
fit1 = fit_survival(model_lorentzian, datas_nacs[1], [0.7, 0.2, 300.49, 0.2])
...
title("306485 GHz, 16 mW, 1 ms")
# ylim([0.44, 0.66])
text(300.503, 0.06, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(300.503, 0.12, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
