...
const inames = ["data_20200202_002554.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs = [365.6 .+ (-5000:500:5000) .* 1e-3]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200202_002554_raman_det_3311")
...
title("306518 GHz, 16 mW, 4 ms")
# ylim([0.44, 0.66])
text(360, 0.365, "\$f=$(fit1.uncs[3])\$ MHz", color="C0", fontsize="small")
text(360, 0.35, "\$\\Gamma=$(fit1.uncs[4] * 1000)\$ kHz", color="C0", fontsize="small")
