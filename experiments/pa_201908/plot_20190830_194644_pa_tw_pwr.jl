...
const names_files = ["names_20190830_194644.mat"]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20190830_194644_pa_tw_pwr")
...
NaCsPlot.plot_survival_data(datas[1][:, 3], fmt="C2.-", label="15 mW")
...
NaCsPlot.plot_survival_data(datas_cscs[1][:, 3], fmt="C2.:", label="Cs 15 mW")
...
NaCsPlot.plot_survival_data(datas_nana[1][:, 3], fmt="C1.:", label="Na 15 mW")
grid()
ylim([0.25, 0.9])
# xlim([495.94, 496.16])
