...
const names_files = ["names_20190810_223441.mat",
                     "names_20190812_110847.mat",
                     "names_20190812_190112.mat"]
...
for ds in [datas, datas_na, datas_cs, datas_nana, datas_cscs]
    ds[1] = [ds[1][1:24]; ds[2][1:end - 1]; ds[3]]
    resize!(ds, 1)
end
...
const prefix = joinpath(@__DIR__, "imgs", "data_20190810_223441_pa")
