...
const names_files = ["names_20190801_181243.mat"]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20190801_181243_pa")

fit = fit_survival(model_lorentzian, datas[1], [0.7, 0.35, 740, 25])
...
text(750, 0.44, "\$f=$(fit.uncs[3])\$ MHz", color="C0", fontsize="small")
text(755, 0.5, "\$\\Gamma=$(fit.uncs[4])\$ MHz", color="C0", fontsize="small")
grid()
ylim([0.35, 0.9])
# xlim([495.95, 496.29])
