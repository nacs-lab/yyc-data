...
const iname_a = joinpath(@__DIR__, "data", "data_20181110_223434.mat")
...
data_na_nocool_az = split_na_a[:az]
data_cs_cool_az = split_cs_a[:cool][:az]
data_cs_cool_rx = split_cs_a[:cool][:rx]
data_cs_cool_ry = split_cs_a[:cool][:ry]
data_cs_nocool_az = split_cs_a[:az]

const prefix = joinpath(@__DIR__, "imgs", "data_20181110_223434_sideband_3d_ax")

figure()
NaCsPlot.plot_survival_data(data_na_nocool_az, fmt="C0.-", label="No cool")
...
figure()
NaCsPlot.plot_survival_data(data_cs_nocool_az, fmt="C0.-", label="No cool")
