...
const iname_a = joinpath(@__DIR__, "data", "data_20181010_143425.mat")
const params_a, logicals_a = NaCsData.load_striped_mat(iname_a)
const spec_a = linspace(-21, 21, 15) .+ 20
...
const data_nacs_a = select_times(NaCsData.select_single((1, 2,), (3, 4,)), 1620 * 3)
const data_nacs_all = NaCsData.split_data(
    NaCsData.select_count(params_a, logicals_a,
                          NaCsData.select_single((1, 2,), (3, 4,))), spec_a)

const prefix = joinpath(@__DIR__, "imgs", "data_20181010_143425_raman_rt")
