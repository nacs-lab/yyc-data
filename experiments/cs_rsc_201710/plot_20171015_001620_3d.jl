...
const iname_a = joinpath(@__DIR__, "data", "data_20171015_001620.csv")
...
data_rx = NaCsData.map_params(to_sideband(50), split_a[:radial_x])
data_ry = NaCsData.map_params(to_sideband(55), split_a[:radial_y])
