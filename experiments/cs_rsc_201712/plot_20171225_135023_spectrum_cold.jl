...
const iname_a = joinpath(@__DIR__, "data", "data_20171225_135023.mat")
...
const split_50 = NaCsData.split_data(data_50_a, spec)
const split_62 = NaCsData.split_data(data_62_a, spec)
...
const prefix = joinpath(@__DIR__, "imgs", "data_20171225")
