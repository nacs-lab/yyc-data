...
const tweezer = [668.35, 565, 560, 555, 510, 503, 492]
const freq = [488, 291.891, 287.282, 283.665, 268.511, 264.912, 263.402]
const freq_unc = [10, 0.038, 0.015, 0.017, 0.023, 0.018, 0.028]

const prefix = joinpath(@__DIR__, "imgs", "data_20200501_raman_vs_tweezer_3322_3")
