...
const freq = [1623, 616.56, 595.80, 577.44, 501.17, 483.50, 475.71]
const freq_unc = [30, 0.21, 0.47, 0.13, 0.83, 0.12, 0.10]

const prefix = joinpath(@__DIR__, "imgs", "data_20200501_ramann_vs_tweezer_3322_15")
