...
const inames = ["data_20200328_200418.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
# const specs = [[0, 0.06, 0.11, 0.16, 0.21, 0.26, 0.31]]
const specs = [[0; [0.08, 0.16, 0.24, 0.32, 0.4, 0.48] .* 3 .- 0.04]]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20200328_200418_raman_time_3322")
...
fit = fit_survival(model_expsin, data, [0.25, 0.5, 0.5, 0.04])
...
text(0.25, 0.16, "\$\\tau=$(fit.uncs[3])\$ ms", color="C0", fontsize="small")
xlim([0, 1.46])
grid()
