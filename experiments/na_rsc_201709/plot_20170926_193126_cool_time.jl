...
idxs, ratios, uncs = group_time(params, counts, (22:58, 80:116, 153:185), 188 * 8 * 16)

const prefix = joinpath(@__DIR__, "imgs", "data_20170926_193126_cool_time")
...
NaCsPlot.maybe_save("$(prefix)_xyz")
