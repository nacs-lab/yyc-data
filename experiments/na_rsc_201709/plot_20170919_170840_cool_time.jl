...
const iname_a = joinpath(@__DIR__, "data", "data_20170919_170840.csv")
...
idxs, ratios, uncs = group_time(params, counts, (1:7, 8:14), 812 * 2)

const prefix = joinpath(@__DIR__, "imgs", "data_20170919_170840_cool_time")
