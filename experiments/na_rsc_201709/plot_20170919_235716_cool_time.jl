...
const iname_a = joinpath(@__DIR__, "data", "data_20170919_235716.csv")
...
idxs, ratios, uncs = group_time(params, counts, (1:7, 8:14), 812 * 4)

const prefix = joinpath(@__DIR__, "imgs", "data_20170919_235716_cool_time")
