...
const inames = ["data_20190309_202812.mat",
                ]
...
fit_nacs = fit_survival(model_exp_off, data_nacs, [0.5, 100, 0.2])

const prefix = joinpath(@__DIR__, "imgs", "data_20190309_202812_raman_time")
