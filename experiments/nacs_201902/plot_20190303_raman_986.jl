...
const inames = ["data_20190303_160022.mat",
                "data_20190303_210300.mat",
                ]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int),
                 typemax(Int),
                 ]
const specs = [640 .+ (-10:0.5:10),
               640 .+ (-4:0.2:4),
               ]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20190303_raman_986")

figure()
NaCsPlot.plot_survival_data(datas_nacs[1], fmt="C0")
NaCsPlot.plot_survival_data(datas_nacs[2], fmt="C1")
grid()
ylim([0, 1])
title("Raman Resonance")
xlabel("Frequency (297XXX kHz)")
