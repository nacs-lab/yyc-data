...
const inames = ["data_20190329_111044.mat",
                ]
...
data_na_lifetime = [datas_na_na[1][1]; datas_na_na[1][3]]
data_na_state = [datas_na_na[1][2]; datas_na_na[1][4]]

data_cs_lifetime0 = datas_cs_cs[1][1]
data_cs_state0 = datas_cs_cs[1][2]
data_cs_lifetime1 = datas_cs_cs[1][3]
data_cs_state1 = datas_cs_cs[1][4]
...
figure()
NaCsPlot.plot_survival_data(data_na_state, fmt="C0.-", label="Na 2,2")
NaCsPlot.plot_survival_data(data_cs_state0, fmt="C1.-", label="Cs 3,3")
NaCsPlot.plot_survival_data(data_cs_state1, fmt="C2.-", label="Cs 4,4")
legend(fontsize="small")
grid()
ylim([0, 1])
xlim([0, 5.5])
