...
const inames = ["data_20190208_234600.mat"]
const datas = [NaCsData.load_striped_mat(joinpath(@__DIR__, "data", iname)) for iname in inames]
const maxcnts = [typemax(Int)]
const specs_cs = [OrderedDict(
    :az=>(-40:2.0:80),
    :rx=>(-153 .+ (-45:6.0:45), 89 .+ (-75:10.0:75)),
    :ry=>(-157 .+ (-45:6.0:45), 112 .+ (-60:8.0:60))
)]
...
const prefix = joinpath(@__DIR__, "imgs", "data_20190208_234600_temp")
