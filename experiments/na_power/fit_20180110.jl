...
const iname_f2_counterop = joinpath(@__DIR__, "data", "f2_counter-op_20180110.csv")
const data_f2_counterop = readdlm(iname_f2_counterop, ',', Float64, skipstart=1)
const iname_f2_coprop = joinpath(@__DIR__, "data", "f2_coprop_20180110.csv")
const data_f2_coprop = readdlm(iname_f2_coprop, ',', Float64, skipstart=1)
const iname_f1_coprop = joinpath(@__DIR__, "data", "f1_coprop_20180110.csv")
const data_f1_coprop = readdlm(iname_f1_coprop, ',', Float64, skipstart=1)
const iname_f1_up = joinpath(@__DIR__, "data", "f1_up_20180110.csv")
const data_f1_up = readdlm(iname_f1_up, ',', Float64, skipstart=1)
const iname_f1_down = joinpath(@__DIR__, "data", "f1_down_20180110.csv")
const data_f1_down = readdlm(iname_f1_down, ',', Float64, skipstart=1)

const prefix = joinpath(@__DIR__, "imgs", "data_20180110")
