...
ylim([0, ylim()[2]])
text(0.31, 2.5, "\$a\\cdot\\sin(b\\cdot\\sin^2(c\\cdot AMP))\$", fontsize=18)
text(0.44, 0.1, params_strs(fit_f2_counterop), fontsize=20)
xlabel("NaRaman2/AMP")
ylabel("Power (mW)")
