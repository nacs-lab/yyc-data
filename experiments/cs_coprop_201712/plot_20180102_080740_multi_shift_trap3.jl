...
const iname_a = joinpath(@__DIR__, "data", "data_20180102_080740.mat")
...
data_50 = NaCsData.select_count(params_a, logicals_a, gen_selector(1), 45000)
data_62 = NaCsData.select_count(params_a, logicals_a, gen_selector(2), 45000)
...
const prefix = joinpath(@__DIR__, "imgs", "data_20180102")
