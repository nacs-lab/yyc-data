...
const iname_a = joinpath(@__DIR__, "data", "data_20171229_233119.mat")
...
const spec = ((linspace(-40, 130, 18) for _ in 1:13)...)
...
const prefix = joinpath(@__DIR__, "imgs", "data_20171229")
...
const plotx = linspace(-50, 140, 10000)
